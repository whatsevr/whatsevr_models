...
# lib/src/deserialize.dart and lib/whatsevr_models.dart, then runs the code
...
rm -rf lib/src/api lib/src/model lib/src/auth lib/src/api.dart \
  lib/src/deserialize.dart lib/whatsevr_models.dart .openapi-generator

npx --yes @openapitools/openapi-generator-cli generate \
  --generator-name dart-dio \
  --input-spec "$spec" \
  --output . \
  --additional-properties=pubName=whatsevr_models,pubVersion=0.0.1,serializationLibrary=json_serializable
...
dart format lib/src/api lib/src/model lib/src/auth lib/src/api.dart \
  lib/src/deserialize.dart lib/whatsevr_models.dart
dart analyze
