...
@override
String toString() {
  return 'CallAcceptResult(room: $room, token: $token, serverUrl: $serverUrl, expiresAt: $expiresAt, isBilled: $isBilled, payerUid: $payerUid, ratePaise: $ratePaise, audioOnly: $audioOnly, pricePerMinutePaise: $pricePerMinutePaise)';
}
...
/// Create a copy of CallAcceptResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? room = null,Object? token = null,Object? serverUrl = null,Object? expiresAt = freezed,Object? isBilled = null,Object? payerUid = freezed,Object? ratePaise = null,Object? audioOnly = null,Object? pricePerMinutePaise = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String room,  String token, @JsonKey(name: 'server_url')  String serverUrl, @JsonKey(name: 'expires_at')  DateTime? expiresAt, @JsonKey(name: 'is_billed')  bool isBilled, @JsonKey(name: 'payer_uid')  String? payerUid, @JsonKey(name: 'rate_paise')  int ratePaise, @JsonKey(name: 'audio_only')  bool audioOnly, @JsonKey(name: 'price_per_minute_paise')  int pricePerMinutePaise)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CallAcceptResult() when $default != null:
return $default(_that.room,_that.token,_that.serverUrl,_that.expiresAt,_that.isBilled,_that.payerUid,_that.ratePaise,_that.audioOnly,_that.pricePerMinutePaise);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String room,  String token, @JsonKey(name: 'server_url')  String serverUrl, @JsonKey(name: 'expires_at')  DateTime? expiresAt, @JsonKey(name: 'is_billed')  bool isBilled, @JsonKey(name: 'payer_uid')  String? payerUid, @JsonKey(name: 'rate_paise')  int ratePaise, @JsonKey(name: 'audio_only')  bool audioOnly, @JsonKey(name: 'price_per_minute_paise')  int pricePerMinutePaise)  $default,) {final _that = this;
switch (_that) {
case _CallAcceptResult():
return $default(_that.room,_that.token,_that.serverUrl,_that.expiresAt,_that.isBilled,_that.payerUid,_that.ratePaise,_that.audioOnly,_that.pricePerMinutePaise);}
}
...
class _CallAcceptResult extends CallAcceptResult {
  const _CallAcceptResult({this.room = '', this.token = '', @JsonKey(name: 'server_url') this.serverUrl = '', @JsonKey(name: 'expires_at') this.expiresAt, @JsonKey(name: 'is_billed') this.isBilled = false, @JsonKey(name: 'payer_uid') this.payerUid, @JsonKey(name: 'rate_paise') this.ratePaise = 0, @JsonKey(name: 'audio_only') this.audioOnly = false, @JsonKey(name: 'price_per_minute_paise') this.pricePerMinutePaise = 0}): super._();
...
/// Create a copy of CallAcceptResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? room = null,Object? token = null,Object? serverUrl = null,Object? expiresAt = freezed,Object? isBilled = null,Object? payerUid = freezed,Object? ratePaise = null,Object? audioOnly = null,Object? pricePerMinutePaise = null,}) {
