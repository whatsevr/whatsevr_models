...
@JsonKey(name: 'earn_rate_paise') int get earnRatePaise;@JsonKey(name: 'can_switch_mode') bool get canSwitchMode;@JsonKey(name: 'video_needs_consent') bool get videoNeedsConsent;
...
/// Create a copy of CallAcceptResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? room = null,Object? token = null,Object? serverUrl = null,Object? expiresAt = freezed,Object? isBilled = null,Object? payerUid = freezed,Object? ratePaise = null,Object? audioOnly = null,Object? pricePerMinutePaise = null,Object? audioPricePerMinutePaise = null,Object? videoPricePerMinutePaise = null,Object? pricePerMinuteCredits = null,Object? audioPricePerMinuteCredits = null,Object? videoPricePerMinuteCredits = null,Object? earnRatePaise = null,Object? canSwitchMode = null,Object? videoNeedsConsent = null,}) {
...
switch (_that) {
case _CallAcceptResult() when $default != null:
return $default(_that.room,_that.token,_that.serverUrl,_that.expiresAt,_that.isBilled,_that.payerUid,_that.ratePaise,_that.audioOnly,_that.pricePerMinutePaise,_that.audioPricePerMinutePaise,_that.videoPricePerMinutePaise,_that.pricePerMinuteCredits,_that.audioPricePerMinuteCredits,_that.videoPricePerMinuteCredits,_that.earnRatePaise,_that.canSwitchMode,_that.videoNeedsConsent);case _:
  return orElse();
...
switch (_that) {
case _CallAcceptResult():
return $default(_that.room,_that.token,_that.serverUrl,_that.expiresAt,_that.isBilled,_that.payerUid,_that.ratePaise,_that.audioOnly,_that.pricePerMinutePaise,_that.audioPricePerMinutePaise,_that.videoPricePerMinutePaise,_that.pricePerMinuteCredits,_that.audioPricePerMinuteCredits,_that.videoPricePerMinuteCredits,_that.earnRatePaise,_that.canSwitchMode,_that.videoNeedsConsent);}
}
...
class _CallAcceptResult extends CallAcceptResult {
  const _CallAcceptResult({this.room = '', this.token = '', @JsonKey(name: 'server_url') this.serverUrl = '', @JsonKey(name: 'expires_at') this.expiresAt, @JsonKey(name: 'is_billed') this.isBilled = false, @JsonKey(name: 'payer_uid') this.payerUid, @JsonKey(name: 'rate_paise') this.ratePaise = 0, @JsonKey(name: 'audio_only') this.audioOnly = false, @JsonKey(name: 'price_per_minute_paise') this.pricePerMinutePaise = 0, @JsonKey(name: 'audio_price_per_minute_paise') this.audioPricePerMinutePaise = 0, @JsonKey(name: 'video_price_per_minute_paise') this.videoPricePerMinutePaise = 0, @JsonKey(name: 'price_per_minute_credits') this.pricePerMinuteCredits = 0, @JsonKey(name: 'audio_price_per_minute_credits') this.audioPricePerMinuteCredits = 0, @JsonKey(name: 'video_price_per_minute_credits') this.videoPricePerMinuteCredits = 0, @JsonKey(name: 'earn_rate_paise') this.earnRatePaise = 0, @JsonKey(name: 'can_switch_mode') this.canSwitchMode = false, @JsonKey(name: 'video_needs_consent') this.videoNeedsConsent = true}): super._();
