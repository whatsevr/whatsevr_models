...
@JsonKey(name: 'is_premium_profile') bool get isPremiumProfile;/// Her level on the pricing ladder, 1..7, and its name. Earned, not paid,
/// and what explains a higher price. A badge only: the grid's order is
/// the server's and does not read it.
@JsonKey(name: 'host_level') int get hostLevel;@JsonKey(name: 'host_level_name') String get hostLevelName;/// What the host says she offers, in her words — the card's hero line and
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,hostUid,name,profilePictureUrl,country,age,city,state,gender,callMode,ratePaise,pricePerMinuteCredits,audioPricePerMinuteCredits,videoPricePerMinuteCredits,status,isPremiumProfile,hostLevel,hostLevelName,headline,occupation,headlineHighlight,invitedAt,answerRatePercent,answeredCallCount,isNewHost]);

@override
String toString() {
  return 'OneToOneCallHost(hostUid: $hostUid, name: $name, profilePictureUrl: $profilePictureUrl, country: $country, age: $age, city: $city, state: $state, gender: $gender, callMode: $callMode, ratePaise: $ratePaise, pricePerMinuteCredits: $pricePerMinuteCredits, audioPricePerMinuteCredits: $audioPricePerMinuteCredits, videoPricePerMinuteCredits: $videoPricePerMinuteCredits, status: $status, isPremiumProfile: $isPremiumProfile, hostLevel: $hostLevel, hostLevelName: $hostLevelName, headline: $headline, occupation: $occupation, headlineHighlight: $headlineHighlight, invitedAt: $invitedAt, answerRatePercent: $answerRatePercent, answeredCallCount: $answeredCallCount, isNewHost: $isNewHost)';
}
...
/// Create a copy of OneToOneCallHost
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hostUid = null,Object? name = null,Object? profilePictureUrl = freezed,Object? country = freezed,Object? age = freezed,Object? city = freezed,Object? state = freezed,Object? gender = freezed,Object? callMode = null,Object? ratePaise = null,Object? pricePerMinuteCredits = null,Object? audioPricePerMinuteCredits = null,Object? videoPricePerMinuteCredits = null,Object? status = null,Object? isPremiumProfile = null,Object? hostLevel = null,Object? hostLevelName = null,Object? headline = freezed,Object? occupation = freezed,Object? headlineHighlight = freezed,Object? invitedAt = freezed,Object? answerRatePercent = freezed,Object? answeredCallCount = null,Object? isNewHost = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'one_to_one_call_host_uid')  String hostUid,  String name, @JsonKey(name: 'profile_picture_url')  String? profilePictureUrl,  String? country,  int? age,  String? city,  String? state,  String? gender, @JsonKey(name: 'call_mode')  String callMode, @JsonKey(name: 'rate_paise')  int ratePaise, @JsonKey(name: 'price_per_minute_credits')  int pricePerMinuteCredits, @JsonKey(name: 'audio_price_per_minute_credits')  int audioPricePerMinuteCredits, @JsonKey(name: 'video_price_per_minute_credits')  int videoPricePerMinuteCredits,  String status, @JsonKey(name: 'is_premium_profile')  bool isPremiumProfile, @JsonKey(name: 'host_level')  int hostLevel, @JsonKey(name: 'host_level_name')  String hostLevelName,  String? headline,  String? occupation, @JsonKey(name: 'headline_highlight')  String? headlineHighlight, @JsonKey(name: 'invited_at')  DateTime? invitedAt, @JsonKey(name: 'answer_rate_percent')  int? answerRatePercent, @JsonKey(name: 'answered_call_count')  int answeredCallCount, @JsonKey(name: 'is_new_host')  bool isNewHost)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OneToOneCallHost() when $default != null:
return $default(_that.hostUid,_that.name,_that.profilePictureUrl,_that.country,_that.age,_that.city,_that.state,_that.gender,_that.callMode,_that.ratePaise,_that.pricePerMinuteCredits,_that.audioPricePerMinuteCredits,_that.videoPricePerMinuteCredits,_that.status,_that.isPremiumProfile,_that.hostLevel,_that.hostLevelName,_that.headline,_that.occupation,_that.headlineHighlight,_that.invitedAt,_that.answerRatePercent,_that.answeredCallCount,_that.isNewHost);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'one_to_one_call_host_uid')  String hostUid,  String name, @JsonKey(name: 'profile_picture_url')  String? profilePictureUrl,  String? country,  int? age,  String? city,  String? state,  String? gender, @JsonKey(name: 'call_mode')  String callMode, @JsonKey(name: 'rate_paise')  int ratePaise, @JsonKey(name: 'price_per_minute_credits')  int pricePerMinuteCredits, @JsonKey(name: 'audio_price_per_minute_credits')  int audioPricePerMinuteCredits, @JsonKey(name: 'video_price_per_minute_credits')  int videoPricePerMinuteCredits,  String status, @JsonKey(name: 'is_premium_profile')  bool isPremiumProfile, @JsonKey(name: 'host_level')  int hostLevel, @JsonKey(name: 'host_level_name')  String hostLevelName,  String? headline,  String? occupation, @JsonKey(name: 'headline_highlight')  String? headlineHighlight, @JsonKey(name: 'invited_at')  DateTime? invitedAt, @JsonKey(name: 'answer_rate_percent')  int? answerRatePercent, @JsonKey(name: 'answered_call_count')  int answeredCallCount, @JsonKey(name: 'is_new_host')  bool isNewHost)  $default,) {final _that = this;
switch (_that) {
case _OneToOneCallHost():
return $default(_that.hostUid,_that.name,_that.profilePictureUrl,_that.country,_that.age,_that.city,_that.state,_that.gender,_that.callMode,_that.ratePaise,_that.pricePerMinuteCredits,_that.audioPricePerMinuteCredits,_that.videoPricePerMinuteCredits,_that.status,_that.isPremiumProfile,_that.hostLevel,_that.hostLevelName,_that.headline,_that.occupation,_that.headlineHighlight,_that.invitedAt,_that.answerRatePercent,_that.answeredCallCount,_that.isNewHost);}
}
...
class _OneToOneCallHost extends OneToOneCallHost {
  const _OneToOneCallHost({@JsonKey(name: 'one_to_one_call_host_uid') this.hostUid = '', this.name = '', @JsonKey(name: 'profile_picture_url') this.profilePictureUrl, this.country, this.age, this.city, this.state, this.gender, @JsonKey(name: 'call_mode') this.callMode = 'audio_video', @JsonKey(name: 'rate_paise') this.ratePaise = 0, @JsonKey(name: 'price_per_minute_credits') this.pricePerMinuteCredits = 0, @JsonKey(name: 'audio_price_per_minute_credits') this.audioPricePerMinuteCredits = 0, @JsonKey(name: 'video_price_per_minute_credits') this.videoPricePerMinuteCredits = 0, this.status = 'offline', @JsonKey(name: 'is_premium_profile') this.isPremiumProfile = false, @JsonKey(name: 'host_level') this.hostLevel = 1, @JsonKey(name: 'host_level_name') this.hostLevelName = 'New Host', this.headline, this.occupation, @JsonKey(name: 'headline_highlight') this.headlineHighlight, @JsonKey(name: 'invited_at') this.invitedAt, @JsonKey(name: 'answer_rate_percent') this.answerRatePercent, @JsonKey(name: 'answered_call_count') this.answeredCallCount = 0, @JsonKey(name: 'is_new_host') this.isNewHost = false}): super._();
