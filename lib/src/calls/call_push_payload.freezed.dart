...
@JsonKey(name: 'ring_window_seconds', fromJson: intFromCallWire) int get ringWindowSeconds;@JsonKey(name: 'rate_paise', fromJson: intFromCallWire) int get ratePaise;@JsonKey(name: 'audio_only', fromJson: boolFromCallWire) bool get audioOnly;@JsonKey(name: 'price_per_minute_paise', fromJson: intFromCallWire) int get pricePerMinutePaise;/// Both modes' prices ride along so the call screen can re-price itself
...
@JsonKey(name: 'price_label') String get priceLabel;/// Whether this call may change mode at all, and whether turning video on
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,type,room,callerUid,callerName,callerAvatar,callerIsPremiumProfile,isVideo,isBilled,payerUid,ringWindowSeconds,ratePaise,audioOnly,pricePerMinutePaise,audioPricePerMinutePaise,videoPricePerMinutePaise,pricePerMinuteCredits,audioPricePerMinuteCredits,videoPricePerMinuteCredits,earnRatePaise,priceLabel,canSwitchMode,videoNeedsConsent,reason]);

@override
String toString() {
  return 'CallPushPayload(type: $type, room: $room, callerUid: $callerUid, callerName: $callerName, callerAvatar: $callerAvatar, callerIsPremiumProfile: $callerIsPremiumProfile, isVideo: $isVideo, isBilled: $isBilled, payerUid: $payerUid, ringWindowSeconds: $ringWindowSeconds, ratePaise: $ratePaise, audioOnly: $audioOnly, pricePerMinutePaise: $pricePerMinutePaise, audioPricePerMinutePaise: $audioPricePerMinutePaise, videoPricePerMinutePaise: $videoPricePerMinutePaise, pricePerMinuteCredits: $pricePerMinuteCredits, audioPricePerMinuteCredits: $audioPricePerMinuteCredits, videoPricePerMinuteCredits: $videoPricePerMinuteCredits, earnRatePaise: $earnRatePaise, priceLabel: $priceLabel, canSwitchMode: $canSwitchMode, videoNeedsConsent: $videoNeedsConsent, reason: $reason)';
}
...
/// Create a copy of CallPushPayload
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? room = null,Object? callerUid = freezed,Object? callerName = freezed,Object? callerAvatar = freezed,Object? callerIsPremiumProfile = null,Object? isVideo = null,Object? isBilled = null,Object? payerUid = freezed,Object? ringWindowSeconds = null,Object? ratePaise = null,Object? audioOnly = null,Object? pricePerMinutePaise = null,Object? audioPricePerMinutePaise = null,Object? videoPricePerMinutePaise = null,Object? pricePerMinuteCredits = null,Object? audioPricePerMinuteCredits = null,Object? videoPricePerMinuteCredits = null,Object? earnRatePaise = null,Object? priceLabel = null,Object? canSwitchMode = null,Object? videoNeedsConsent = null,Object? reason = freezed,}) {
...
switch (_that) {
case _CallPushPayload() when $default != null:
return $default(_that.type,_that.room,_that.callerUid,_that.callerName,_that.callerAvatar,_that.callerIsPremiumProfile,_that.isVideo,_that.isBilled,_that.payerUid,_that.ringWindowSeconds,_that.ratePaise,_that.audioOnly,_that.pricePerMinutePaise,_that.audioPricePerMinutePaise,_that.videoPricePerMinutePaise,_that.pricePerMinuteCredits,_that.audioPricePerMinuteCredits,_that.videoPricePerMinuteCredits,_that.earnRatePaise,_that.priceLabel,_that.canSwitchMode,_that.videoNeedsConsent,_that.reason);case _:
  return orElse();
...
switch (_that) {
case _CallPushPayload():
return $default(_that.type,_that.room,_that.callerUid,_that.callerName,_that.callerAvatar,_that.callerIsPremiumProfile,_that.isVideo,_that.isBilled,_that.payerUid,_that.ringWindowSeconds,_that.ratePaise,_that.audioOnly,_that.pricePerMinutePaise,_that.audioPricePerMinutePaise,_that.videoPricePerMinutePaise,_that.pricePerMinuteCredits,_that.audioPricePerMinuteCredits,_that.videoPricePerMinuteCredits,_that.earnRatePaise,_that.priceLabel,_that.canSwitchMode,_that.videoNeedsConsent,_that.reason);}
}
...
class _CallPushPayload extends CallPushPayload {
  const _CallPushPayload({this.type = '', this.room = '', @JsonKey(name: 'caller_uid') this.callerUid, @JsonKey(name: 'caller_name') this.callerName, @JsonKey(name: 'caller_avatar') this.callerAvatar, @JsonKey(name: 'caller_is_premium_profile', fromJson: boolFromCallWire) this.callerIsPremiumProfile = false, @JsonKey(name: 'is_video', fromJson: boolFromCallWire) this.isVideo = false, @JsonKey(name: 'is_billed', fromJson: boolFromCallWire) this.isBilled = false, @JsonKey(name: 'payer_uid') this.payerUid, @JsonKey(name: 'ring_window_seconds', fromJson: intFromCallWire) this.ringWindowSeconds = 0, @JsonKey(name: 'rate_paise', fromJson: intFromCallWire) this.ratePaise = 0, @JsonKey(name: 'audio_only', fromJson: boolFromCallWire) this.audioOnly = false, @JsonKey(name: 'price_per_minute_paise', fromJson: intFromCallWire) this.pricePerMinutePaise = 0, @JsonKey(name: 'audio_price_per_minute_paise', fromJson: intFromCallWire) this.audioPricePerMinutePaise = 0, @JsonKey(name: 'video_price_per_minute_paise', fromJson: intFromCallWire) this.videoPricePerMinutePaise = 0, @JsonKey(name: 'price_per_minute_credits', fromJson: intFromCallWire) this.pricePerMinuteCredits = 0, @JsonKey(name: 'audio_price_per_minute_credits', fromJson: intFromCallWire) this.audioPricePerMinuteCredits = 0, @JsonKey(name: 'video_price_per_minute_credits', fromJson: intFromCallWire) this.videoPricePerMinuteCredits = 0, @JsonKey(name: 'earn_rate_paise', fromJson: intFromCallWire) this.earnRatePaise = 0, @JsonKey(name: 'price_label') this.priceLabel = '', @JsonKey(name: 'can_switch_mode', fromJson: boolFromCallWire) this.canSwitchMode = false, @JsonKey(name: 'video_needs_consent', fromJson: boolFromCallWire) this.videoNeedsConsent = true, this.reason}): super._();
...
/// Create a copy of CallPushPayload
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? room = null,Object? callerUid = freezed,Object? callerName = freezed,Object? callerAvatar = freezed,Object? callerIsPremiumProfile = null,Object? isVideo = null,Object? isBilled = null,Object? payerUid = freezed,Object? ringWindowSeconds = null,Object? ratePaise = null,Object? audioOnly = null,Object? pricePerMinutePaise = null,Object? audioPricePerMinutePaise = null,Object? videoPricePerMinutePaise = null,Object? pricePerMinuteCredits = null,Object? audioPricePerMinuteCredits = null,Object? videoPricePerMinuteCredits = null,Object? earnRatePaise = null,Object? priceLabel = null,Object? canSwitchMode = null,Object? videoNeedsConsent = null,Object? reason = freezed,}) {
