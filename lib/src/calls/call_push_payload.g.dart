...
_CallPushPayload _$CallPushPayloadFromJson(Map<String, dynamic> json) =>
    _CallPushPayload(
      ...
      callerIsPremiumProfile: json['caller_is_premium_profile'] == null
          ? false
          : boolFromCallWire(json['caller_is_premium_profile']),
      isVideo: json['is_video'] == null
          ? false
          : boolFromCallWire(json['is_video']),
      isBilled: json['is_billed'] == null
          ? false
          : boolFromCallWire(json['is_billed']),
      ...
      audioOnly: json['audio_only'] == null
          ? false
          : boolFromCallWire(json['audio_only']),
      pricePerMinutePaise: json['price_per_minute_paise'] == null
          ? 0
          : intFromCallWire(json['price_per_minute_paise']),
      audioPricePerMinutePaise: json['audio_price_per_minute_paise'] == null
          ? 0
          : intFromCallWire(json['audio_price_per_minute_paise']),
      videoPricePerMinutePaise: json['video_price_per_minute_paise'] == null
          ? 0
          : intFromCallWire(json['video_price_per_minute_paise']),
      pricePerMinuteCredits: json['price_per_minute_credits'] == null
          ? 0
          : intFromCallWire(json['price_per_minute_credits']),
      audioPricePerMinuteCredits: json['audio_price_per_minute_credits'] == null
          ? 0
          : intFromCallWire(json['audio_price_per_minute_credits']),
      videoPricePerMinuteCredits: json['video_price_per_minute_credits'] == null
          ? 0
          : intFromCallWire(json['video_price_per_minute_credits']),
      earnRatePaise: json['earn_rate_paise'] == null
          ? 0
      ...
      videoNeedsConsent: json['video_needs_consent'] == null
          ? true
