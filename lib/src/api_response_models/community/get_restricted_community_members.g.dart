...
_$$GetRestrictedCommunityMembersResponseImplFromJson(
  ...
  result:
      (json['result'] as List<dynamic>?)
          ?.map(
            (e) =>
                RestrictedCommunityMember.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
);

Map<String, dynamic> _$$GetRestrictedCommunityMembersResponseImplToJson(
  _$GetRestrictedCommunityMembersResponseImpl instance,
) => <String, dynamic>{
...
_$RestrictedCommunityMemberImpl _$$RestrictedCommunityMemberImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$RestrictedCommunityMemberImplToJson(
  _$RestrictedCommunityMemberImpl instance,
) => <String, dynamic>{
