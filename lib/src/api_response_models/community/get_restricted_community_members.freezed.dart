...
@JsonKey(name: 'message') String? get message;@JsonKey(name: 'page') int? get page;@JsonKey(name: 'last_page') bool? get lastPage;@JsonKey(name: 'result') List<RestrictedCommunityMember>? get result;
/// Create a copy of GetRestrictedCommunityMembersResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$GetRestrictedCommunityMembersResponseCopyWith<GetRestrictedCommunityMembersResponse> get copyWith => _$GetRestrictedCommunityMembersResponseCopyWithImpl<GetRestrictedCommunityMembersResponse>(this as GetRestrictedCommunityMembersResponse, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetRestrictedCommunityMembersResponse&&(identical(other.message, message) || other.message == message)&&(identical(other.page, page) || other.page == page)&&(identical(other.lastPage, lastPage) || other.lastPage == lastPage)&&const DeepCollectionEquality().equals(other.result, result));
}
...
/// @nodoc
abstract mixin class $GetRestrictedCommunityMembersResponseCopyWith<$Res>  {
  factory $GetRestrictedCommunityMembersResponseCopyWith(GetRestrictedCommunityMembersResponse value, $Res Function(GetRestrictedCommunityMembersResponse) _then) = _$GetRestrictedCommunityMembersResponseCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'message') String? message,@JsonKey(name: 'page') int? page,@JsonKey(name: 'last_page') bool? lastPage,@JsonKey(name: 'result') List<RestrictedCommunityMember>? result
});
...
/// @nodoc
class _$GetRestrictedCommunityMembersResponseCopyWithImpl<$Res>
    implements $GetRestrictedCommunityMembersResponseCopyWith<$Res> {
  _$GetRestrictedCommunityMembersResponseCopyWithImpl(this._self, this._then);

  final GetRestrictedCommunityMembersResponse _self;
  final $Res Function(GetRestrictedCommunityMembersResponse) _then;
...
/// Adds pattern-matching-related methods to [GetRestrictedCommunityMembersResponse].
extension GetRestrictedCommunityMembersResponsePatterns on GetRestrictedCommunityMembersResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GetRestrictedCommunityMembersResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GetRestrictedCommunityMembersResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GetRestrictedCommunityMembersResponse value)  $default,){
final _that = this;
switch (_that) {
case _GetRestrictedCommunityMembersResponse():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GetRestrictedCommunityMembersResponse value)?  $default,){
final _that = this;
switch (_that) {
case _GetRestrictedCommunityMembersResponse() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'message')  String? message, @JsonKey(name: 'page')  int? page, @JsonKey(name: 'last_page')  bool? lastPage, @JsonKey(name: 'result')  List<RestrictedCommunityMember>? result)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetRestrictedCommunityMembersResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'message')  String? message, @JsonKey(name: 'page')  int? page, @JsonKey(name: 'last_page')  bool? lastPage, @JsonKey(name: 'result')  List<RestrictedCommunityMember>? result)  $default,) {final _that = this;
switch (_that) {
case _GetRestrictedCommunityMembersResponse():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'message')  String? message, @JsonKey(name: 'page')  int? page, @JsonKey(name: 'last_page')  bool? lastPage, @JsonKey(name: 'result')  List<RestrictedCommunityMember>? result)?  $default,) {final _that = this;
switch (_that) {
case _GetRestrictedCommunityMembersResponse() when $default != null:
return $default(_that.message,_that.page,_that.lastPage,_that.result);case _:
  return null;
...
class _GetRestrictedCommunityMembersResponse implements GetRestrictedCommunityMembersResponse {
  const _GetRestrictedCommunityMembersResponse({@JsonKey(name: 'message') this.message, @JsonKey(name: 'page') this.page, @JsonKey(name: 'last_page') this.lastPage, @JsonKey(name: 'result') final  List<RestrictedCommunityMember>? result}): _result = result;
  factory _GetRestrictedCommunityMembersResponse.fromJson(Map<String, dynamic> json) => _$GetRestrictedCommunityMembersResponseFromJson(json);
...
@override@JsonKey(name: 'result') List<RestrictedCommunityMember>? get result {
  final value = _result;
...
@pragma('vm:prefer-inline')
_$GetRestrictedCommunityMembersResponseCopyWith<_GetRestrictedCommunityMembersResponse> get copyWith => __$GetRestrictedCommunityMembersResponseCopyWithImpl<_GetRestrictedCommunityMembersResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GetRestrictedCommunityMembersResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetRestrictedCommunityMembersResponse&&(identical(other.message, message) || other.message == message)&&(identical(other.page, page) || other.page == page)&&(identical(other.lastPage, lastPage) || other.lastPage == lastPage)&&const DeepCollectionEquality().equals(other._result, _result));
}
...
/// @nodoc
abstract mixin class _$GetRestrictedCommunityMembersResponseCopyWith<$Res> implements $GetRestrictedCommunityMembersResponseCopyWith<$Res> {
  factory _$GetRestrictedCommunityMembersResponseCopyWith(_GetRestrictedCommunityMembersResponse value, $Res Function(_GetRestrictedCommunityMembersResponse) _then) = __$GetRestrictedCommunityMembersResponseCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'message') String? message,@JsonKey(name: 'page') int? page,@JsonKey(name: 'last_page') bool? lastPage,@JsonKey(name: 'result') List<RestrictedCommunityMember>? result
});
...
/// @nodoc
class __$GetRestrictedCommunityMembersResponseCopyWithImpl<$Res>
    implements _$GetRestrictedCommunityMembersResponseCopyWith<$Res> {
  __$GetRestrictedCommunityMembersResponseCopyWithImpl(this._self, this._then);

  final _GetRestrictedCommunityMembersResponse _self;
  final $Res Function(_GetRestrictedCommunityMembersResponse) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? message = freezed,Object? page = freezed,Object? lastPage = freezed,Object? result = freezed,}) {
  return _then(_GetRestrictedCommunityMembersResponse(
message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String?,page: freezed == page ? _self.page : page // ignore: cast_nullable_to_non_nullable
as int?,lastPage: freezed == lastPage ? _self.lastPage : lastPage // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract mixin class $RestrictedCommunityMemberCopyWith<$Res>  {
  factory $RestrictedCommunityMemberCopyWith(RestrictedCommunityMember value, $Res Function(RestrictedCommunityMember) _then) = _$RestrictedCommunityMemberCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$RestrictedCommunityMemberCopyWithImpl<$Res>
    implements $RestrictedCommunityMemberCopyWith<$Res> {
  _$RestrictedCommunityMemberCopyWithImpl(this._self, this._then);

  final RestrictedCommunityMember _self;
  final $Res Function(RestrictedCommunityMember) _then;
...
/// Adds pattern-matching-related methods to [RestrictedCommunityMember].
extension RestrictedCommunityMemberPatterns on RestrictedCommunityMember {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RestrictedCommunityMember value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RestrictedCommunityMember() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RestrictedCommunityMember value)  $default,){
final _that = this;
switch (_that) {
case _RestrictedCommunityMember():
return $default(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RestrictedCommunityMember value)?  $default,){
final _that = this;
switch (_that) {
case _RestrictedCommunityMember() when $default != null:
return $default(_that);case _:
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$RestrictedCommunityMemberCopyWith<_RestrictedCommunityMember> get copyWith => __$RestrictedCommunityMemberCopyWithImpl<_RestrictedCommunityMember>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RestrictedCommunityMemberToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RestrictedCommunityMember&&(identical(other.communityUid, communityUid) || other.communityUid == communityUid)&&(identical(other.userUid, userUid) || other.userUid == userUid)&&(identical(other.joinedAt, joinedAt) || other.joinedAt == joinedAt)&&(identical(other.role, role) || other.role == role)&&(identical(other.status, status) || other.status == status)&&(identical(other.lastActiveAt, lastActiveAt) || other.lastActiveAt == lastActiveAt)&&(identical(other.joinRequestMessage, joinRequestMessage) || other.joinRequestMessage == joinRequestMessage)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.user, user) || other.user == user));
}
...
/// @nodoc
abstract mixin class _$RestrictedCommunityMemberCopyWith<$Res> implements $RestrictedCommunityMemberCopyWith<$Res> {
  factory _$RestrictedCommunityMemberCopyWith(_RestrictedCommunityMember value, $Res Function(_RestrictedCommunityMember) _then) = __$RestrictedCommunityMemberCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'community_uid') String? communityUid,@JsonKey(name: 'user_uid') String? userUid,@JsonKey(name: 'joined_at') DateTime? joinedAt,@JsonKey(name: 'role') String? role,@JsonKey(name: 'status') String? status,@JsonKey(name: 'last_active_at') DateTime? lastActiveAt,@JsonKey(name: 'join_request_message') String? joinRequestMessage,@JsonKey(name: 'notes') String? notes,@JsonKey(name: 'uid') String? uid,@JsonKey(name: 'updated_at') DateTime? updatedAt,@JsonKey(name: 'user') UserData? user
});
...
/// @nodoc
class __$RestrictedCommunityMemberCopyWithImpl<$Res>
    implements _$RestrictedCommunityMemberCopyWith<$Res> {
  __$RestrictedCommunityMemberCopyWithImpl(this._self, this._then);

  final _RestrictedCommunityMember _self;
  final $Res Function(_RestrictedCommunityMember) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? communityUid = freezed,Object? userUid = freezed,Object? joinedAt = freezed,Object? role = freezed,Object? status = freezed,Object? lastActiveAt = freezed,Object? joinRequestMessage = freezed,Object? notes = freezed,Object? uid = freezed,Object? updatedAt = freezed,Object? user = freezed,}) {
  return _then(_RestrictedCommunityMember(
communityUid: freezed == communityUid ? _self.communityUid : communityUid // ignore: cast_nullable_to_non_nullable
as String?,userUid: freezed == userUid ? _self.userUid : userUid // ignore: cast_nullable_to_non_nullable
as String?,joinedAt: freezed == joinedAt ? _self.joinedAt : joinedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,role: freezed == role ? _self.role : role // ignore: cast_nullable_to_non_nullable
