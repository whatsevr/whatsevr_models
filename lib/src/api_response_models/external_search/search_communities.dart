...
@freezed
sealed class ExternalSearchCommunitiesResult
    with _$ExternalSearchCommunitiesResult {
  const factory ExternalSearchCommunitiesResult({
    @JsonKey(name: 'success') bool? success,

    @JsonKey(name: 'message') String? message,

    @JsonKey(name: 'results') List<ExternalSearchedCommunity>? results,

    @JsonKey(name: 'pagination') CommunitiesPagination? pagination,
...
sealed class ExternalSearchedCommunity with _$ExternalSearchedCommunity {
  const factory ExternalSearchedCommunity({
    ...
    @JsonKey(name: 'cover_media') List<SearchedCommunityCoverMedia>? coverMedia,

    @JsonKey(name: 'services') List<SearchedCommunityService>? services,
