...
sealed class ExternalSearchOffersResult with _$ExternalSearchOffersResult {
  const factory ExternalSearchOffersResult({
    ...
    @JsonKey(name: 'results') List<SearchedOffer>? results,

    @JsonKey(name: 'pagination') OffersPagination? pagination,
...
sealed class SearchedOffer with _$SearchedOffer {
  const factory SearchedOffer({
    ...
    @JsonKey(name: 'files_data') List<OfferFileData>? filesData,
    ...
    @JsonKey(name: 'creator') OfferCreator? creator,
  }) = _SearchedOffer;
