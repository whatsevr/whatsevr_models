...
sealed class ExternalSearchPhotosResult with _$ExternalSearchPhotosResult {
  const factory ExternalSearchPhotosResult({
    ...
    @JsonKey(name: 'results') List<SearchedPhoto>? results,

    @JsonKey(name: 'pagination') PhotosPagination? pagination,
...
sealed class SearchedPhoto with _$SearchedPhoto {
  const factory SearchedPhoto({
    ...
    @JsonKey(name: 'cumulative_score') int? cumulativeScore,

    @JsonKey(name: 'files_data') List<PhotoFileData>? filesData,
    ...
    @JsonKey(name: 'creator') PhotoCreator? creator,
  }) = _SearchedPhoto;
