...
/// @nodoc
mixin _$ExternalSearchWtvsResult {
...
/// Create a copy of ExternalSearchWtvsResult
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ExternalSearchWtvsResultCopyWith<ExternalSearchWtvsResult> get copyWith => _$ExternalSearchWtvsResultCopyWithImpl<ExternalSearchWtvsResult>(this as ExternalSearchWtvsResult, _$identity);

  /// Serializes this ExternalSearchWtvsResult to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExternalSearchWtvsResult&&(identical(other.success, success) || other.success == success)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other.results, results)&&(identical(other.pagination, pagination) || other.pagination == pagination));
}
...
@override
String toString() {
  return 'ExternalSearchWtvsResult(success: $success, message: $message, results: $results, pagination: $pagination)';
}
...
/// @nodoc
abstract mixin class $ExternalSearchWtvsResultCopyWith<$Res>  {
  factory $ExternalSearchWtvsResultCopyWith(ExternalSearchWtvsResult value, $Res Function(ExternalSearchWtvsResult) _then) = _$ExternalSearchWtvsResultCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ExternalSearchWtvsResultCopyWithImpl<$Res>
    implements $ExternalSearchWtvsResultCopyWith<$Res> {
  _$ExternalSearchWtvsResultCopyWithImpl(this._self, this._then);

  final ExternalSearchWtvsResult _self;
  final $Res Function(ExternalSearchWtvsResult) _then;
...
/// Adds pattern-matching-related methods to [ExternalSearchWtvsResult].
extension ExternalSearchWtvsResultPatterns on ExternalSearchWtvsResult {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ExternalSearchWtvsResult value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ExternalSearchWtvsResult() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ExternalSearchWtvsResult value)  $default,){
final _that = this;
switch (_that) {
case _ExternalSearchWtvsResult():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ExternalSearchWtvsResult value)?  $default,){
final _that = this;
switch (_that) {
case _ExternalSearchWtvsResult() when $default != null:
return $default(_that);case _:
...
class _ExternalSearchWtvsResult implements ExternalSearchWtvsResult {
  const _ExternalSearchWtvsResult({@JsonKey(name: 'success') this.success, @JsonKey(name: 'message') this.message, @JsonKey(name: 'results') final  List<SearchedWtv>? results, @JsonKey(name: 'pagination') this.pagination}): _results = results;
  factory _ExternalSearchWtvsResult.fromJson(Map<String, dynamic> json) => _$ExternalSearchWtvsResultFromJson(json);
...
@pragma('vm:prefer-inline')
_$ExternalSearchWtvsResultCopyWith<_ExternalSearchWtvsResult> get copyWith => __$ExternalSearchWtvsResultCopyWithImpl<_ExternalSearchWtvsResult>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ExternalSearchWtvsResultToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ExternalSearchWtvsResult&&(identical(other.success, success) || other.success == success)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._results, _results)&&(identical(other.pagination, pagination) || other.pagination == pagination));
}
...
/// @nodoc
abstract mixin class _$ExternalSearchWtvsResultCopyWith<$Res> implements $ExternalSearchWtvsResultCopyWith<$Res> {
  factory _$ExternalSearchWtvsResultCopyWith(_ExternalSearchWtvsResult value, $Res Function(_ExternalSearchWtvsResult) _then) = __$ExternalSearchWtvsResultCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'success') bool? success,@JsonKey(name: 'message') String? message,@JsonKey(name: 'results') List<SearchedWtv>? results,@JsonKey(name: 'pagination') WtvsPagination? pagination
});
...
/// @nodoc
class __$ExternalSearchWtvsResultCopyWithImpl<$Res>
    implements _$ExternalSearchWtvsResultCopyWith<$Res> {
  __$ExternalSearchWtvsResultCopyWithImpl(this._self, this._then);

  final _ExternalSearchWtvsResult _self;
  final $Res Function(_ExternalSearchWtvsResult) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? success = freezed,Object? message = freezed,Object? results = freezed,Object? pagination = freezed,}) {
  return _then(_ExternalSearchWtvsResult(
success: freezed == success ? _self.success : success // ignore: cast_nullable_to_non_nullable
as bool?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,createdAt,uid,title,description,const DeepCollectionEquality().hash(hashtags),const DeepCollectionEquality().hash(taggedUserUids),isArchived,isActive,postCreatorType,updatedAt,userUid,thumbnail,videoUrl,location,totalViews,totalReactions,totalComments,internalAiDescription,addressLatLongWkb,creatorLatLongWkb,const DeepCollectionEquality().hash(taggedCommunityUids),totalShares,cumulativeScore,videoDurationInSec,seoDataWeighted,communityUid,externalSearchIndexedAt,creator]);
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'uid')  String? uid, @JsonKey(name: 'title')  String? title, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'hashtags')  List<String>? hashtags, @JsonKey(name: 'tagged_user_uids')  List<String>? taggedUserUids, @JsonKey(name: 'is_archived')  bool? isArchived, @JsonKey(name: 'is_active')  bool? isActive, @JsonKey(name: 'post_creator_type')  String? postCreatorType, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'user_uid')  String? userUid, @JsonKey(name: 'thumbnail')  String? thumbnail, @JsonKey(name: 'video_url')  String? videoUrl, @JsonKey(name: 'location')  String? location, @JsonKey(name: 'total_views')  int? totalViews, @JsonKey(name: 'total_reactions')  int? totalReactions, @JsonKey(name: 'total_comments')  int? totalComments, @JsonKey(name: 'internal_ai_description')  String? internalAiDescription, @JsonKey(name: 'address_lat_long_wkb')  String? addressLatLongWkb, @JsonKey(name: 'creator_lat_long_wkb')  String? creatorLatLongWkb, @JsonKey(name: 'tagged_community_uids')  List<String>? taggedCommunityUids, @JsonKey(name: 'total_shares')  int? totalShares, @JsonKey(name: 'cumulative_score')  int? cumulativeScore, @JsonKey(name: 'video_duration_in_sec')  int? videoDurationInSec, @JsonKey(name: 'seo_data_weighted')  String? seoDataWeighted, @JsonKey(name: 'community_uid')  String? communityUid, @JsonKey(name: 'external_search_indexed_at')  DateTime? externalSearchIndexedAt, @JsonKey(name: 'creator')  WtvCreator? creator)  $default,) {final _that = this;
switch (_that) {
case _SearchedWtv():
return $default(_that.createdAt,_that.uid,_that.title,_that.description,_that.hashtags,_that.taggedUserUids,_that.isArchived,_that.isActive,_that.postCreatorType,_that.updatedAt,_that.userUid,_that.thumbnail,_that.videoUrl,_that.location,_that.totalViews,_that.totalReactions,_that.totalComments,_that.internalAiDescription,_that.addressLatLongWkb,_that.creatorLatLongWkb,_that.taggedCommunityUids,_that.totalShares,_that.cumulativeScore,_that.videoDurationInSec,_that.seoDataWeighted,_that.communityUid,_that.externalSearchIndexedAt,_that.creator);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,createdAt,uid,title,description,const DeepCollectionEquality().hash(_hashtags),const DeepCollectionEquality().hash(_taggedUserUids),isArchived,isActive,postCreatorType,updatedAt,userUid,thumbnail,videoUrl,location,totalViews,totalReactions,totalComments,internalAiDescription,addressLatLongWkb,creatorLatLongWkb,const DeepCollectionEquality().hash(_taggedCommunityUids),totalShares,cumulativeScore,videoDurationInSec,seoDataWeighted,communityUid,externalSearchIndexedAt,creator]);
...
@override
String toString() {
  return 'WtvCreator(uid: $uid, name: $name, username: $username, isPortfolio: $isPortfolio, portfolioTitle: $portfolioTitle, profilePicture: $profilePicture, totalFollowers: $totalFollowers)';
}
...
class _WtvCreator implements WtvCreator {
  const _WtvCreator({@JsonKey(name: 'uid') this.uid, @JsonKey(name: 'name') this.name, @JsonKey(name: 'username') this.username, @JsonKey(name: 'is_portfolio') this.isPortfolio, @JsonKey(name: 'portfolio_title') this.portfolioTitle, @JsonKey(name: 'profile_picture') this.profilePicture, @JsonKey(name: 'total_followers') this.totalFollowers});
