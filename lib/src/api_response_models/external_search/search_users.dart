...
sealed class ExternalSearchUsersResult with _$ExternalSearchUsersResult {
  const factory ExternalSearchUsersResult({
    ...
    @JsonKey(name: 'results') List<ExternalSearchUser>? results,

    @JsonKey(name: 'pagination') UsersPagination? pagination,
...
sealed class ExternalSearchUser with _$ExternalSearchUser {
  const factory ExternalSearchUser({
    ...
    @JsonKey(name: 'educations') List<SearchedUserEducation>? educations,

    @JsonKey(name: 'work_experiences')
    List<SearchedUserWorkExperience>? workExperiences,

    @JsonKey(name: 'cover_media') List<UserCoverMedia>? coverMedia,

    @JsonKey(name: 'services') List<UserService>? services,
  }) = _ExternalSearchUser;
