...
sealed class OpenSearchSneekpeekCandidatesResult
  ...
  const factory OpenSearchSneekpeekCandidatesResult({
    ...
    @JsonKey(name: 'results') List<SearchedSneekpeekCandidate>? results,
...
sealed class SearchedSneekpeekCandidate with _$SearchedSneekpeekCandidate {
  const factory SearchedSneekpeekCandidate({
    ...
    @JsonKey(name: 'is_in_queue') bool? isInQueue,

    @JsonKey(name: 'queue_joined_at') DateTime? queueJoinedAt,
    ...
    @JsonKey(name: 'direct_availability') String? directAvailability,
...
@freezed
sealed class SneekpeekCandidatesPagination
    with _$SneekpeekCandidatesPagination {
