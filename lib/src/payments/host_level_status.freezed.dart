...
@JsonKey(name: 'holding_bars_met') bool get holdingBarsMet;@JsonKey(name: 'holding_remaining_sentence') String get holdingRemainingSentence;/// She missed her level's bars last month; missing them again drops her
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,level,levelName,pricePaise,audioPricePaise,pricePerMinuteCredits,isTopLevel,monthLabel,nextRecalculationAt,nextLevel,nextLevelName,nextPricePaise,const DeepCollectionEquality().hash(bars),remainingSentence,holdingBarsMet,holdingRemainingSentence,graceActive,graceMonthLabel,unacknowledgedEvent);

@override
String toString() {
  return 'HostLevelStatus(level: $level, levelName: $levelName, pricePaise: $pricePaise, audioPricePaise: $audioPricePaise, pricePerMinuteCredits: $pricePerMinuteCredits, isTopLevel: $isTopLevel, monthLabel: $monthLabel, nextRecalculationAt: $nextRecalculationAt, nextLevel: $nextLevel, nextLevelName: $nextLevelName, nextPricePaise: $nextPricePaise, bars: $bars, remainingSentence: $remainingSentence, holdingBarsMet: $holdingBarsMet, holdingRemainingSentence: $holdingRemainingSentence, graceActive: $graceActive, graceMonthLabel: $graceMonthLabel, unacknowledgedEvent: $unacknowledgedEvent)';
}
...
switch (_that) {
case _HostLevelStatus() when $default != null:
return $default(_that.level,_that.levelName,_that.pricePaise,_that.audioPricePaise,_that.pricePerMinuteCredits,_that.isTopLevel,_that.monthLabel,_that.nextRecalculationAt,_that.nextLevel,_that.nextLevelName,_that.nextPricePaise,_that.bars,_that.remainingSentence,_that.holdingBarsMet,_that.holdingRemainingSentence,_that.graceActive,_that.graceMonthLabel,_that.unacknowledgedEvent);case _:
  return orElse();
...
switch (_that) {
case _HostLevelStatus():
return $default(_that.level,_that.levelName,_that.pricePaise,_that.audioPricePaise,_that.pricePerMinuteCredits,_that.isTopLevel,_that.monthLabel,_that.nextRecalculationAt,_that.nextLevel,_that.nextLevelName,_that.nextPricePaise,_that.bars,_that.remainingSentence,_that.holdingBarsMet,_that.holdingRemainingSentence,_that.graceActive,_that.graceMonthLabel,_that.unacknowledgedEvent);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,level,levelName,pricePaise,audioPricePaise,pricePerMinuteCredits,isTopLevel,monthLabel,nextRecalculationAt,nextLevel,nextLevelName,nextPricePaise,const DeepCollectionEquality().hash(_bars),remainingSentence,holdingBarsMet,holdingRemainingSentence,graceActive,graceMonthLabel,unacknowledgedEvent);
