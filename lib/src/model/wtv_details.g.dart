...
part of 'wtv_details.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$WtvDetailsCWProxy {
  WtvDetails addressLatLongWkb(String? addressLatLongWkb);

  WtvDetails author(UsersRow? author);

  WtvDetails comments(List<PostDetailsCommentRow> comments);

  WtvDetails communityUid(String? communityUid);

  WtvDetails createdAt(DateTime createdAt);

  WtvDetails creatorLatLongWkb(String? creatorLatLongWkb);

  WtvDetails cumulativeScore(num? cumulativeScore);

  WtvDetails description(String? description);

  WtvDetails externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  WtvDetails hashtags(List<String>? hashtags);

  WtvDetails internalAiDescription(String? internalAiDescription);

  WtvDetails isArchived(bool? isArchived);

  WtvDetails location(String? location);

  WtvDetails postCreatorType(String postCreatorType);

  WtvDetails seoDataWeighted(String? seoDataWeighted);

  WtvDetails taggedCommunityUids(List<String>? taggedCommunityUids);

  WtvDetails taggedUserUids(List<String>? taggedUserUids);

  WtvDetails thumbnail(String? thumbnail);

  WtvDetails title(String title);

  WtvDetails totalComments(int? totalComments);

  WtvDetails totalReactions(int? totalReactions);

  WtvDetails totalShares(int? totalShares);
  ...
  WtvDetails userUid(String userUid);

  WtvDetails videoDurationInSec(int? videoDurationInSec);

  WtvDetails videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `WtvDetails(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// WtvDetails(...).copyWith(id: 12, name: "My name")
  /// ```
  WtvDetails call({
...
/// Use as `instanceOfWtvDetails.copyWith(...)` or call `instanceOfWtvDetails.copyWith.fieldName(value)` for a single field.
class _$WtvDetailsCWProxyImpl implements _$WtvDetailsCWProxy {
  const _$WtvDetailsCWProxyImpl(this._value);

  final WtvDetails _value;
  ...
  @override
  WtvDetails author(UsersRow? author) => call(author: author);
  ...
  @override
  WtvDetails createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  WtvDetails description(String? description) => call(description: description);
  ...
  @override
  WtvDetails hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  WtvDetails isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  WtvDetails location(String? location) => call(location: location);
  ...
  @override
  WtvDetails thumbnail(String? thumbnail) => call(thumbnail: thumbnail);

  @override
  WtvDetails title(String title) => call(title: title);
  ...
  @override
  WtvDetails totalShares(int? totalShares) => call(totalShares: totalShares);
  ...
  @override
  WtvDetails userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  WtvDetails videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $WtvDetailsCopyWith on WtvDetails {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfWtvDetails.copyWith(...)` or `instanceOfWtvDetails.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$WtvDetailsCWProxy get copyWith => _$WtvDetailsCWProxyImpl(this);
}
...
WtvDetails _$WtvDetailsFromJson(Map<String, dynamic> json) => $checkedCreate(
  'WtvDetails',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$WtvDetailsToJson(WtvDetails instance) =>
    <String, dynamic>{
