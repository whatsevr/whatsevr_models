...
part 'community_search_result_row.g.dart';
...
class CommunitySearchResultRow {
  /// Returns a new [CommunitySearchResultRow] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is CommunitySearchResultRow &&
          other.admin == admin &&
  ...
  factory CommunitySearchResultRow.fromJson(Map<String, dynamic> json) =>
      _$CommunitySearchResultRowFromJson(json);

  Map<String, dynamic> toJson() => _$CommunitySearchResultRowToJson(this);
