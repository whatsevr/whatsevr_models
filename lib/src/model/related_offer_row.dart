...
class RelatedOfferRow {
  /// Returns a new [RelatedOfferRow] instance.
  RelatedOfferRow({
    this.author,
  ...
  factory RelatedOfferRow.fromJson(Map<String, dynamic> json) =>
      _$RelatedOfferRowFromJson(json);

  Map<String, dynamic> toJson() => _$RelatedOfferRowToJson(this);
