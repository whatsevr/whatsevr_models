...
part of 'external_search_photo_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$ExternalSearchPhotoRowCWProxy {
  ExternalSearchPhotoRow addressLatLongWkb(String? addressLatLongWkb);

  ExternalSearchPhotoRow communityUid(String? communityUid);

  ExternalSearchPhotoRow createdAt(DateTime createdAt);

  ExternalSearchPhotoRow creator(CreatorInfo? creator);

  ExternalSearchPhotoRow creatorLatLongWkb(String? creatorLatLongWkb);

  ExternalSearchPhotoRow cumulativeScore(num? cumulativeScore);

  ExternalSearchPhotoRow description(String? description);

  ExternalSearchPhotoRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  );

  ExternalSearchPhotoRow filesData(List<PostFileEntry>? filesData);

  ExternalSearchPhotoRow hashtags(List<String>? hashtags);

  ExternalSearchPhotoRow internalAiDescription(String? internalAiDescription);

  ExternalSearchPhotoRow isArchived(bool? isArchived);

  ExternalSearchPhotoRow location(String? location);

  ExternalSearchPhotoRow postCreatorType(String postCreatorType);

  ExternalSearchPhotoRow seoDataWeighted(String? seoDataWeighted);

  ExternalSearchPhotoRow taggedCommunityUids(List<String>? taggedCommunityUids);

  ExternalSearchPhotoRow taggedUserUids(List<String>? taggedUserUids);

  ExternalSearchPhotoRow title(String title);

  ExternalSearchPhotoRow totalComments(int? totalComments);

  ExternalSearchPhotoRow totalImpressions(int? totalImpressions);

  ExternalSearchPhotoRow totalReactions(int? totalReactions);
  ...
  ExternalSearchPhotoRow userUid(String userUid);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `ExternalSearchPhotoRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// ExternalSearchPhotoRow(...).copyWith(id: 12, name: "My name")
  /// ```
  ExternalSearchPhotoRow call({
...
/// Use as `instanceOfExternalSearchPhotoRow.copyWith(...)` or call `instanceOfExternalSearchPhotoRow.copyWith.fieldName(value)` for a single field.
class _$ExternalSearchPhotoRowCWProxyImpl
    implements _$ExternalSearchPhotoRowCWProxy {
  const _$ExternalSearchPhotoRowCWProxyImpl(this._value);

  final ExternalSearchPhotoRow _value;
  ...
  @override
  ExternalSearchPhotoRow location(String? location) => call(location: location);
  ...
  @override
  ExternalSearchPhotoRow taggedCommunityUids(
    List<String>? taggedCommunityUids,
  ...
  @override
  ExternalSearchPhotoRow title(String title) => call(title: title);
  ...
  @override
  ExternalSearchPhotoRow userUid(String userUid) => call(userUid: userUid);
...
extension $ExternalSearchPhotoRowCopyWith on ExternalSearchPhotoRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfExternalSearchPhotoRow.copyWith(...)` or `instanceOfExternalSearchPhotoRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$ExternalSearchPhotoRowCWProxy get copyWith =>
      _$ExternalSearchPhotoRowCWProxyImpl(this);
}
...
ExternalSearchPhotoRow _$ExternalSearchPhotoRowFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'ExternalSearchPhotoRow',
  json,
  ($checkedConvert) {
    $checkKeys(
      json,
    ...
    final val = ExternalSearchPhotoRow(
...
Map<String, dynamic> _$ExternalSearchPhotoRowToJson(
  ExternalSearchPhotoRow instance,
) => <String, dynamic>{
