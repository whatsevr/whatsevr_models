...
part 'public_recommendations_mix_content_row.g.dart';
...
class PublicRecommendationsMixContentRow {
  /// Returns a new [PublicRecommendationsMixContentRow] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is PublicRecommendationsMixContentRow &&
  ...
  factory PublicRecommendationsMixContentRow.fromJson(
    Map<String, dynamic> json,
  ) => _$PublicRecommendationsMixContentRowFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PublicRecommendationsMixContentRowToJson(this);
