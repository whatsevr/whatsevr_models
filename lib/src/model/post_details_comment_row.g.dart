...
part of 'post_details_comment_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PostDetailsCommentRowCWProxy {
  PostDetailsCommentRow author(UsersRow? author);

  PostDetailsCommentRow commentText(String commentText);

  PostDetailsCommentRow contentOwnerUserUid(String contentOwnerUserUid);

  PostDetailsCommentRow contentType(String? contentType);

  PostDetailsCommentRow createdAt(DateTime createdAt);

  PostDetailsCommentRow flickUid(String? flickUid);

  PostDetailsCommentRow imageUrl(String? imageUrl);

  PostDetailsCommentRow memoryUid(String? memoryUid);

  PostDetailsCommentRow offerUid(String? offerUid);

  PostDetailsCommentRow pdfUid(String? pdfUid);

  PostDetailsCommentRow photoUid(String? photoUid);
  ...
  PostDetailsCommentRow userUid(String userUid);

  PostDetailsCommentRow wtvUid(String? wtvUid);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PostDetailsCommentRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PostDetailsCommentRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PostDetailsCommentRow call({
    UsersRow? author,
    String commentText,
...
/// Use as `instanceOfPostDetailsCommentRow.copyWith(...)` or call `instanceOfPostDetailsCommentRow.copyWith.fieldName(value)` for a single field.
class _$PostDetailsCommentRowCWProxyImpl
    implements _$PostDetailsCommentRowCWProxy {
  const _$PostDetailsCommentRowCWProxyImpl(this._value);

  final PostDetailsCommentRow _value;

  @override
  PostDetailsCommentRow author(UsersRow? author) => call(author: author);
  ...
  @override
  PostDetailsCommentRow flickUid(String? flickUid) => call(flickUid: flickUid);

  @override
  PostDetailsCommentRow imageUrl(String? imageUrl) => call(imageUrl: imageUrl);
  ...
  @override
  PostDetailsCommentRow offerUid(String? offerUid) => call(offerUid: offerUid);

  @override
  PostDetailsCommentRow pdfUid(String? pdfUid) => call(pdfUid: pdfUid);

  @override
  PostDetailsCommentRow photoUid(String? photoUid) => call(photoUid: photoUid);
  ...
  @override
  PostDetailsCommentRow userUid(String userUid) => call(userUid: userUid);

  @override
  PostDetailsCommentRow wtvUid(String? wtvUid) => call(wtvUid: wtvUid);
...
extension $PostDetailsCommentRowCopyWith on PostDetailsCommentRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPostDetailsCommentRow.copyWith(...)` or `instanceOfPostDetailsCommentRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PostDetailsCommentRowCWProxy get copyWith =>
      _$PostDetailsCommentRowCWProxyImpl(this);
}
...
PostDetailsCommentRow _$PostDetailsCommentRowFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = PostDetailsCommentRow(
...
Map<String, dynamic> _$PostDetailsCommentRowToJson(
  PostDetailsCommentRow instance,
) => <String, dynamic>{
