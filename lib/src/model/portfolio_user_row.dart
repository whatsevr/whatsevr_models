...
part 'portfolio_user_row.g.dart';
...
class PortfolioUserRow {
  /// Returns a new [PortfolioUserRow] instance.
  PortfolioUserRow({
    this.address,
  ...
  factory PortfolioUserRow.fromJson(Map<String, dynamic> json) =>
      _$PortfolioUserRowFromJson(json);

  Map<String, dynamic> toJson() => _$PortfolioUserRowToJson(this);
