...
part of 'related_photo_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$RelatedPhotoRowCWProxy {
  RelatedPhotoRow addressLatLongWkb(String? addressLatLongWkb);

  RelatedPhotoRow author(UsersRow? author);

  RelatedPhotoRow communityUid(String? communityUid);

  RelatedPhotoRow createdAt(DateTime createdAt);

  RelatedPhotoRow creatorLatLongWkb(String? creatorLatLongWkb);

  RelatedPhotoRow cumulativeScore(num? cumulativeScore);

  RelatedPhotoRow description(String? description);

  RelatedPhotoRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  RelatedPhotoRow filesData(List<PostFileEntry>? filesData);

  RelatedPhotoRow hashtags(List<String>? hashtags);

  RelatedPhotoRow internalAiDescription(String? internalAiDescription);

  RelatedPhotoRow isArchived(bool? isArchived);

  RelatedPhotoRow location(String? location);

  RelatedPhotoRow postCreatorType(String postCreatorType);

  RelatedPhotoRow seoDataWeighted(String? seoDataWeighted);

  RelatedPhotoRow taggedCommunityUids(List<String>? taggedCommunityUids);

  RelatedPhotoRow taggedUserUids(List<String>? taggedUserUids);

  RelatedPhotoRow title(String title);

  RelatedPhotoRow totalComments(int? totalComments);

  RelatedPhotoRow totalImpressions(int? totalImpressions);

  RelatedPhotoRow totalReactions(int? totalReactions);

  RelatedPhotoRow totalShares(int? totalShares);

  RelatedPhotoRow uid(String? uid);

  RelatedPhotoRow updatedAt(DateTime? updatedAt);

  RelatedPhotoRow user(UsersRow? user);

  RelatedPhotoRow userUid(String userUid);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `RelatedPhotoRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// RelatedPhotoRow(...).copyWith(id: 12, name: "My name")
  /// ```
  RelatedPhotoRow call({
...
/// Use as `instanceOfRelatedPhotoRow.copyWith(...)` or call `instanceOfRelatedPhotoRow.copyWith.fieldName(value)` for a single field.
class _$RelatedPhotoRowCWProxyImpl implements _$RelatedPhotoRowCWProxy {
  const _$RelatedPhotoRowCWProxyImpl(this._value);

  final RelatedPhotoRow _value;
  ...
  @override
  RelatedPhotoRow author(UsersRow? author) => call(author: author);
  ...
  @override
  RelatedPhotoRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  RelatedPhotoRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  RelatedPhotoRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  RelatedPhotoRow location(String? location) => call(location: location);
  ...
  @override
  RelatedPhotoRow title(String title) => call(title: title);
  ...
  @override
  RelatedPhotoRow uid(String? uid) => call(uid: uid);

  @override
  RelatedPhotoRow updatedAt(DateTime? updatedAt) => call(updatedAt: updatedAt);

  @override
  RelatedPhotoRow user(UsersRow? user) => call(user: user);

  @override
  RelatedPhotoRow userUid(String userUid) => call(userUid: userUid);
...
extension $RelatedPhotoRowCopyWith on RelatedPhotoRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfRelatedPhotoRow.copyWith(...)` or `instanceOfRelatedPhotoRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$RelatedPhotoRowCWProxy get copyWith => _$RelatedPhotoRowCWProxyImpl(this);
}
...
RelatedPhotoRow _$RelatedPhotoRowFromJson(
...
Map<String, dynamic> _$RelatedPhotoRowToJson(RelatedPhotoRow instance) =>
    <String, dynamic>{
