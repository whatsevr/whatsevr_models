...
class OwnCandidateRow {
  /// Returns a new [OwnCandidateRow] instance.
  OwnCandidateRow({
    this.age,
  ...
  Map<String, dynamic> toJson() => _$OwnCandidateRowToJson(this);
