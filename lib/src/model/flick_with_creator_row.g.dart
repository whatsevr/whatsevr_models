...
part of 'flick_with_creator_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$FlickWithCreatorRowCWProxy {
  FlickWithCreatorRow addressLatLongWkb(String? addressLatLongWkb);

  FlickWithCreatorRow communityUid(String? communityUid);

  FlickWithCreatorRow createdAt(DateTime createdAt);

  FlickWithCreatorRow creator(UsersRow? creator);

  FlickWithCreatorRow creatorLatLongWkb(String? creatorLatLongWkb);

  FlickWithCreatorRow cumulativeScore(num? cumulativeScore);

  FlickWithCreatorRow description(String? description);

  FlickWithCreatorRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  );

  FlickWithCreatorRow hashtags(List<String>? hashtags);

  FlickWithCreatorRow internalAiDescription(String? internalAiDescription);

  FlickWithCreatorRow isArchived(bool? isArchived);

  FlickWithCreatorRow location(String? location);

  FlickWithCreatorRow optimizedFiles(Object optimizedFiles);

  FlickWithCreatorRow postCreatorType(String postCreatorType);

  FlickWithCreatorRow relatedContentUid(String? relatedContentUid);

  FlickWithCreatorRow seoDataWeighted(String? seoDataWeighted);

  FlickWithCreatorRow taggedCommunityUids(List<String>? taggedCommunityUids);

  FlickWithCreatorRow taggedUserUids(List<String>? taggedUserUids);

  FlickWithCreatorRow thumbnail(String? thumbnail);

  FlickWithCreatorRow title(String title);

  FlickWithCreatorRow totalComments(int? totalComments);

  FlickWithCreatorRow totalReactions(int? totalReactions);

  FlickWithCreatorRow totalShares(int? totalShares);
  ...
  FlickWithCreatorRow userUid(String userUid);

  FlickWithCreatorRow videoDurationInSec(int? videoDurationInSec);

  FlickWithCreatorRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `FlickWithCreatorRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// FlickWithCreatorRow(...).copyWith(id: 12, name: "My name")
  /// ```
  FlickWithCreatorRow call({
...
/// Use as `instanceOfFlickWithCreatorRow.copyWith(...)` or call `instanceOfFlickWithCreatorRow.copyWith.fieldName(value)` for a single field.
class _$FlickWithCreatorRowCWProxyImpl implements _$FlickWithCreatorRowCWProxy {
  const _$FlickWithCreatorRowCWProxyImpl(this._value);

  final FlickWithCreatorRow _value;
  ...
  @override
  FlickWithCreatorRow creator(UsersRow? creator) => call(creator: creator);
  ...
  @override
  FlickWithCreatorRow location(String? location) => call(location: location);
  ...
  @override
  FlickWithCreatorRow title(String title) => call(title: title);
  ...
  @override
  FlickWithCreatorRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  FlickWithCreatorRow videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $FlickWithCreatorRowCopyWith on FlickWithCreatorRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfFlickWithCreatorRow.copyWith(...)` or `instanceOfFlickWithCreatorRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$FlickWithCreatorRowCWProxy get copyWith =>
      _$FlickWithCreatorRowCWProxyImpl(this);
}
...
FlickWithCreatorRow _$FlickWithCreatorRowFromJson(
...
Map<String, dynamic> _$FlickWithCreatorRowToJson(
  FlickWithCreatorRow instance,
) => <String, dynamic>{
