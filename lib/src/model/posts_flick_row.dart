...
class PostsFlickRow {
  /// Returns a new [PostsFlickRow] instance.
  PostsFlickRow({
  ...
  factory PostsFlickRow.fromJson(Map<String, dynamic> json) =>
      _$PostsFlickRowFromJson(json);

  Map<String, dynamic> toJson() => _$PostsFlickRowToJson(this);
