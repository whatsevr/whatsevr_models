...
part 'posts_mix_content_row.g.dart';
...
class PostsMixContentRow {
  /// Returns a new [PostsMixContentRow] instance.
  PostsMixContentRow({
  ...
  factory PostsMixContentRow.fromJson(Map<String, dynamic> json) =>
      _$PostsMixContentRowFromJson(json);

  Map<String, dynamic> toJson() => _$PostsMixContentRowToJson(this);
