...
part of 'public_recommendations_flick_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PublicRecommendationsFlickRowCWProxy {
  PublicRecommendationsFlickRow addressLatLongWkb(String? addressLatLongWkb);

  PublicRecommendationsFlickRow communityUid(String? communityUid);

  PublicRecommendationsFlickRow createdAt(DateTime createdAt);

  PublicRecommendationsFlickRow creatorLatLongWkb(String? creatorLatLongWkb);

  PublicRecommendationsFlickRow cumulativeScore(num? cumulativeScore);

  PublicRecommendationsFlickRow description(String? description);

  PublicRecommendationsFlickRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  );

  PublicRecommendationsFlickRow hashtags(List<String>? hashtags);

  PublicRecommendationsFlickRow internalAiDescription(
    String? internalAiDescription,
  );

  PublicRecommendationsFlickRow isArchived(bool? isArchived);

  PublicRecommendationsFlickRow location(String? location);

  PublicRecommendationsFlickRow optimizedFiles(Object optimizedFiles);

  PublicRecommendationsFlickRow postCreatorType(String postCreatorType);

  PublicRecommendationsFlickRow relatedContentUid(String? relatedContentUid);

  PublicRecommendationsFlickRow seoDataWeighted(String? seoDataWeighted);

  PublicRecommendationsFlickRow taggedCommunityUids(
    List<String>? taggedCommunityUids,
  );

  PublicRecommendationsFlickRow taggedUserUids(List<String>? taggedUserUids);

  PublicRecommendationsFlickRow thumbnail(String? thumbnail);

  PublicRecommendationsFlickRow title(String title);

  PublicRecommendationsFlickRow totalComments(int? totalComments);

  PublicRecommendationsFlickRow totalReactions(int? totalReactions);

  PublicRecommendationsFlickRow totalShares(int? totalShares);
  ...
  PublicRecommendationsFlickRow user(UsersRow? user);

  PublicRecommendationsFlickRow userUid(String userUid);

  PublicRecommendationsFlickRow videoDurationInSec(int? videoDurationInSec);

  PublicRecommendationsFlickRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PublicRecommendationsFlickRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PublicRecommendationsFlickRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PublicRecommendationsFlickRow call({
...
/// Use as `instanceOfPublicRecommendationsFlickRow.copyWith(...)` or call `instanceOfPublicRecommendationsFlickRow.copyWith.fieldName(value)` for a single field.
class _$PublicRecommendationsFlickRowCWProxyImpl
    implements _$PublicRecommendationsFlickRowCWProxy {
  const _$PublicRecommendationsFlickRowCWProxyImpl(this._value);

  final PublicRecommendationsFlickRow _value;
  ...
  @override
  PublicRecommendationsFlickRow title(String title) => call(title: title);
  ...
  @override
  PublicRecommendationsFlickRow user(UsersRow? user) => call(user: user);
  ...
  PublicRecommendationsFlickRow call({
    ...
    return PublicRecommendationsFlickRow(
...
extension $PublicRecommendationsFlickRowCopyWith
    on PublicRecommendationsFlickRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPublicRecommendationsFlickRow.copyWith(...)` or `instanceOfPublicRecommendationsFlickRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PublicRecommendationsFlickRowCWProxy get copyWith =>
      _$PublicRecommendationsFlickRowCWProxyImpl(this);
}
...
PublicRecommendationsFlickRow _$PublicRecommendationsFlickRowFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'PublicRecommendationsFlickRow',
  json,
  ($checkedConvert) {
    $checkKeys(
      json,
    ...
    final val = PublicRecommendationsFlickRow(
...
Map<String, dynamic> _$PublicRecommendationsFlickRowToJson(
  PublicRecommendationsFlickRow instance,
) => <String, dynamic>{
