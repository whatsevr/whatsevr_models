...
class WtvDetails {
  /// Returns a new [WtvDetails] instance.
  WtvDetails({
  ...
  factory WtvDetails.fromJson(Map<String, dynamic> json) =>
      _$WtvDetailsFromJson(json);

  Map<String, dynamic> toJson() => _$WtvDetailsToJson(this);
