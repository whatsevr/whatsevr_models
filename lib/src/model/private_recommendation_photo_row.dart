...
part 'private_recommendation_photo_row.g.dart';
...
class PrivateRecommendationPhotoRow {
  /// Returns a new [PrivateRecommendationPhotoRow] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is PrivateRecommendationPhotoRow &&
  ...
  factory PrivateRecommendationPhotoRow.fromJson(Map<String, dynamic> json) =>
      _$PrivateRecommendationPhotoRowFromJson(json);

  Map<String, dynamic> toJson() => _$PrivateRecommendationPhotoRowToJson(this);
