...
part of 'flick_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$FlickRowCWProxy {
  FlickRow addressLatLongWkb(String? addressLatLongWkb);

  FlickRow communityUid(String? communityUid);

  FlickRow createdAt(DateTime createdAt);

  FlickRow creatorLatLongWkb(String? creatorLatLongWkb);

  FlickRow cumulativeScore(num? cumulativeScore);

  FlickRow description(String? description);

  FlickRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  FlickRow hashtags(List<String>? hashtags);

  FlickRow internalAiDescription(String? internalAiDescription);

  FlickRow isArchived(bool? isArchived);

  FlickRow location(String? location);

  FlickRow optimizedFiles(Object optimizedFiles);

  FlickRow postCreatorType(String postCreatorType);

  FlickRow relatedContentUid(String? relatedContentUid);

  FlickRow seoDataWeighted(String? seoDataWeighted);

  FlickRow taggedCommunityUids(List<String>? taggedCommunityUids);

  FlickRow taggedUserUids(List<String>? taggedUserUids);

  FlickRow thumbnail(String? thumbnail);

  FlickRow title(String title);

  FlickRow totalComments(int? totalComments);

  FlickRow totalReactions(int? totalReactions);

  FlickRow totalShares(int? totalShares);
  ...
  FlickRow userUid(String userUid);

  FlickRow videoDurationInSec(int? videoDurationInSec);

  FlickRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `FlickRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// FlickRow(...).copyWith(id: 12, name: "My name")
  /// ```
  FlickRow call({
...
/// Use as `instanceOfFlickRow.copyWith(...)` or call `instanceOfFlickRow.copyWith.fieldName(value)` for a single field.
class _$FlickRowCWProxyImpl implements _$FlickRowCWProxy {
  const _$FlickRowCWProxyImpl(this._value);

  final FlickRow _value;
  ...
  @override
  FlickRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  FlickRow description(String? description) => call(description: description);
  ...
  @override
  FlickRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  FlickRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  FlickRow location(String? location) => call(location: location);
  ...
  @override
  FlickRow thumbnail(String? thumbnail) => call(thumbnail: thumbnail);

  @override
  FlickRow title(String title) => call(title: title);
  ...
  @override
  FlickRow totalShares(int? totalShares) => call(totalShares: totalShares);
  ...
  @override
  FlickRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  FlickRow videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $FlickRowCopyWith on FlickRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfFlickRow.copyWith(...)` or `instanceOfFlickRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$FlickRowCWProxy get copyWith => _$FlickRowCWProxyImpl(this);
}
...
FlickRow _$FlickRowFromJson(Map<String, dynamic> json) => $checkedCreate(
  'FlickRow',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$FlickRowToJson(FlickRow instance) => <String, dynamic>{
