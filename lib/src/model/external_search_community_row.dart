...
part 'external_search_community_row.g.dart';
...
class ExternalSearchCommunityRow {
  /// Returns a new [ExternalSearchCommunityRow] instance.
  ...
  @JsonKey(name: r'cover_media', required: true, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is ExternalSearchCommunityRow &&
          other.admin == admin &&
  ...
  factory ExternalSearchCommunityRow.fromJson(Map<String, dynamic> json) =>
      _$ExternalSearchCommunityRowFromJson(json);

  Map<String, dynamic> toJson() => _$ExternalSearchCommunityRowToJson(this);
