...
abstract class _$PhotoDetailsCWProxy {
  PhotoDetails addressLatLongWkb(String? addressLatLongWkb);

  PhotoDetails author(UsersRow? author);

  PhotoDetails comments(List<PostDetailsCommentRow> comments);

  PhotoDetails communityUid(String? communityUid);

  PhotoDetails createdAt(DateTime createdAt);

  PhotoDetails creatorLatLongWkb(String? creatorLatLongWkb);

  PhotoDetails cumulativeScore(num? cumulativeScore);

  PhotoDetails description(String? description);

  PhotoDetails externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  PhotoDetails filesData(List<PostFileEntry>? filesData);

  PhotoDetails hashtags(List<String>? hashtags);

  PhotoDetails internalAiDescription(String? internalAiDescription);

  PhotoDetails isArchived(bool? isArchived);

  PhotoDetails location(String? location);

  PhotoDetails postCreatorType(String postCreatorType);

  PhotoDetails seoDataWeighted(String? seoDataWeighted);

  PhotoDetails taggedCommunityUids(List<String>? taggedCommunityUids);

  PhotoDetails taggedUserUids(List<String>? taggedUserUids);

  PhotoDetails title(String title);

  PhotoDetails totalComments(int? totalComments);

  PhotoDetails totalImpressions(int? totalImpressions);

  PhotoDetails totalReactions(int? totalReactions);
  ...
  PhotoDetails userUid(String userUid);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PhotoDetails(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PhotoDetails(...).copyWith(id: 12, name: "My name")
  /// ```
  PhotoDetails call({
...
/// Use as `instanceOfPhotoDetails.copyWith(...)` or call `instanceOfPhotoDetails.copyWith.fieldName(value)` for a single field.
class _$PhotoDetailsCWProxyImpl implements _$PhotoDetailsCWProxy {
  const _$PhotoDetailsCWProxyImpl(this._value);
  ...
  @override
  PhotoDetails author(UsersRow? author) => call(author: author);
  ...
  @override
  PhotoDetails createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  PhotoDetails hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  PhotoDetails isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  PhotoDetails location(String? location) => call(location: location);
  ...
  @override
  PhotoDetails title(String title) => call(title: title);
  ...
  @override
  PhotoDetails userUid(String userUid) => call(userUid: userUid);
...
extension $PhotoDetailsCopyWith on PhotoDetails {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPhotoDetails.copyWith(...)` or `instanceOfPhotoDetails.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PhotoDetailsCWProxy get copyWith => _$PhotoDetailsCWProxyImpl(this);
}
...
PhotoDetails _$PhotoDetailsFromJson(
