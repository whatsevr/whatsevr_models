...
part 'external_search_pdf_row.g.dart';
...
class ExternalSearchPdfRow {
  /// Returns a new [ExternalSearchPdfRow] instance.
  ...
  factory ExternalSearchPdfRow.fromJson(Map<String, dynamic> json) =>
      _$ExternalSearchPdfRowFromJson(json);

  Map<String, dynamic> toJson() => _$ExternalSearchPdfRowToJson(this);
