...
part of 'memory_with_creator_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$MemoryWithCreatorRowCWProxy {
  MemoryWithCreatorRow addressLatLongWkb(String? addressLatLongWkb);

  MemoryWithCreatorRow caption(String? caption);

  MemoryWithCreatorRow communityUid(String? communityUid);

  MemoryWithCreatorRow createdAt(DateTime createdAt);

  MemoryWithCreatorRow creator(UsersRow? creator);

  MemoryWithCreatorRow creatorLatLongWkb(String? creatorLatLongWkb);

  MemoryWithCreatorRow ctaAction(String? ctaAction);

  MemoryWithCreatorRow ctaActionUrl(String? ctaActionUrl);

  MemoryWithCreatorRow cumulativeScore(num? cumulativeScore);

  MemoryWithCreatorRow expiresAt(DateTime? expiresAt);

  MemoryWithCreatorRow hashtags(List<String>? hashtags);

  MemoryWithCreatorRow imageUrl(String? imageUrl);

  MemoryWithCreatorRow internalAiDescription(String? internalAiDescription);

  MemoryWithCreatorRow isActive(bool? isActive);

  MemoryWithCreatorRow isArchived(bool? isArchived);

  MemoryWithCreatorRow isImage(bool? isImage);

  MemoryWithCreatorRow isText(bool? isText);

  MemoryWithCreatorRow isVideo(bool? isVideo);

  MemoryWithCreatorRow location(String? location);

  MemoryWithCreatorRow postCreatorType(String postCreatorType);

  MemoryWithCreatorRow seoDataWeighted(String? seoDataWeighted);

  MemoryWithCreatorRow taggedCommunityUids(List<String>? taggedCommunityUids);

  MemoryWithCreatorRow taggedUserUids(List<String>? taggedUserUids);

  MemoryWithCreatorRow totalComments(int? totalComments);

  MemoryWithCreatorRow totalReactions(int? totalReactions);

  MemoryWithCreatorRow totalShares(int? totalShares);

  MemoryWithCreatorRow totalViews(int? totalViews);

  MemoryWithCreatorRow uid(String uid);

  MemoryWithCreatorRow updatedAt(DateTime? updatedAt);

  MemoryWithCreatorRow userUid(String userUid);

  MemoryWithCreatorRow videoDurationMs(int? videoDurationMs);

  MemoryWithCreatorRow videoUrl(String? videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `MemoryWithCreatorRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// MemoryWithCreatorRow(...).copyWith(id: 12, name: "My name")
  /// ```
  MemoryWithCreatorRow call({
...
/// Use as `instanceOfMemoryWithCreatorRow.copyWith(...)` or call `instanceOfMemoryWithCreatorRow.copyWith.fieldName(value)` for a single field.
class _$MemoryWithCreatorRowCWProxyImpl
    implements _$MemoryWithCreatorRowCWProxy {
  const _$MemoryWithCreatorRowCWProxyImpl(this._value);

  final MemoryWithCreatorRow _value;
  ...
  @override
  MemoryWithCreatorRow caption(String? caption) => call(caption: caption);
  ...
  @override
  MemoryWithCreatorRow creator(UsersRow? creator) => call(creator: creator);
  ...
  @override
  MemoryWithCreatorRow imageUrl(String? imageUrl) => call(imageUrl: imageUrl);
  ...
  @override
  MemoryWithCreatorRow isActive(bool? isActive) => call(isActive: isActive);
  ...
  @override
  MemoryWithCreatorRow isImage(bool? isImage) => call(isImage: isImage);

  @override
  MemoryWithCreatorRow isText(bool? isText) => call(isText: isText);

  @override
  MemoryWithCreatorRow isVideo(bool? isVideo) => call(isVideo: isVideo);

  @override
  MemoryWithCreatorRow location(String? location) => call(location: location);
  ...
  @override
  MemoryWithCreatorRow uid(String uid) => call(uid: uid);
  ...
  @override
  MemoryWithCreatorRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  MemoryWithCreatorRow videoUrl(String? videoUrl) => call(videoUrl: videoUrl);
...
extension $MemoryWithCreatorRowCopyWith on MemoryWithCreatorRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfMemoryWithCreatorRow.copyWith(...)` or `instanceOfMemoryWithCreatorRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$MemoryWithCreatorRowCWProxy get copyWith =>
      _$MemoryWithCreatorRowCWProxyImpl(this);
}
...
MemoryWithCreatorRow _$MemoryWithCreatorRowFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = MemoryWithCreatorRow(
...
Map<String, dynamic> _$MemoryWithCreatorRowToJson(
  MemoryWithCreatorRow instance,
) => <String, dynamic>{
