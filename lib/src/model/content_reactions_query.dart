...
part 'content_reactions_query.g.dart';
...
class ContentReactionsQuery {
  /// Returns a new [ContentReactionsQuery] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is ContentReactionsQuery &&
  ...
  factory ContentReactionsQuery.fromJson(Map<String, dynamic> json) =>
      _$ContentReactionsQueryFromJson(json);

  Map<String, dynamic> toJson() => _$ContentReactionsQueryToJson(this);
