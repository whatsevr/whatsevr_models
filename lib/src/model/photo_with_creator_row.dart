...
part 'photo_with_creator_row.g.dart';
...
class PhotoWithCreatorRow {
  /// Returns a new [PhotoWithCreatorRow] instance.
  PhotoWithCreatorRow({
  ...
  factory PhotoWithCreatorRow.fromJson(Map<String, dynamic> json) =>
      _$PhotoWithCreatorRowFromJson(json);

  Map<String, dynamic> toJson() => _$PhotoWithCreatorRowToJson(this);
