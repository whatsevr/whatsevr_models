...
part of 'external_search_wtv_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$ExternalSearchWtvRowCWProxy {
  ExternalSearchWtvRow addressLatLongWkb(String? addressLatLongWkb);

  ExternalSearchWtvRow communityUid(String? communityUid);

  ExternalSearchWtvRow createdAt(DateTime createdAt);

  ExternalSearchWtvRow creator(CreatorInfo? creator);

  ExternalSearchWtvRow creatorLatLongWkb(String? creatorLatLongWkb);

  ExternalSearchWtvRow cumulativeScore(num? cumulativeScore);

  ExternalSearchWtvRow description(String? description);

  ExternalSearchWtvRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  );

  ExternalSearchWtvRow hashtags(List<String>? hashtags);

  ExternalSearchWtvRow internalAiDescription(String? internalAiDescription);

  ExternalSearchWtvRow isArchived(bool? isArchived);

  ExternalSearchWtvRow location(String? location);

  ExternalSearchWtvRow postCreatorType(String postCreatorType);

  ExternalSearchWtvRow seoDataWeighted(String? seoDataWeighted);

  ExternalSearchWtvRow taggedCommunityUids(List<String>? taggedCommunityUids);

  ExternalSearchWtvRow taggedUserUids(List<String>? taggedUserUids);

  ExternalSearchWtvRow thumbnail(String? thumbnail);

  ExternalSearchWtvRow title(String title);

  ExternalSearchWtvRow totalComments(int? totalComments);

  ExternalSearchWtvRow totalReactions(int? totalReactions);

  ExternalSearchWtvRow totalShares(int? totalShares);
  ...
  ExternalSearchWtvRow userUid(String userUid);

  ExternalSearchWtvRow videoDurationInSec(int? videoDurationInSec);

  ExternalSearchWtvRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `ExternalSearchWtvRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// ExternalSearchWtvRow(...).copyWith(id: 12, name: "My name")
  /// ```
  ExternalSearchWtvRow call({
...
/// Use as `instanceOfExternalSearchWtvRow.copyWith(...)` or call `instanceOfExternalSearchWtvRow.copyWith.fieldName(value)` for a single field.
class _$ExternalSearchWtvRowCWProxyImpl
    implements _$ExternalSearchWtvRowCWProxy {
  const _$ExternalSearchWtvRowCWProxyImpl(this._value);

  final ExternalSearchWtvRow _value;
  ...
  @override
  ExternalSearchWtvRow creator(CreatorInfo? creator) => call(creator: creator);
  ...
  @override
  ExternalSearchWtvRow location(String? location) => call(location: location);
  ...
  @override
  ExternalSearchWtvRow title(String title) => call(title: title);
  ...
  @override
  ExternalSearchWtvRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  ExternalSearchWtvRow videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $ExternalSearchWtvRowCopyWith on ExternalSearchWtvRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfExternalSearchWtvRow.copyWith(...)` or `instanceOfExternalSearchWtvRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$ExternalSearchWtvRowCWProxy get copyWith =>
      _$ExternalSearchWtvRowCWProxyImpl(this);
}
...
ExternalSearchWtvRow _$ExternalSearchWtvRowFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'ExternalSearchWtvRow',
  json,
  ($checkedConvert) {
    $checkKeys(
      json,
    ...
    final val = ExternalSearchWtvRow(
...
Map<String, dynamic> _$ExternalSearchWtvRowToJson(
  ExternalSearchWtvRow instance,
) => <String, dynamic>{
