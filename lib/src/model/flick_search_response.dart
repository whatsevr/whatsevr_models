...
part 'flick_search_response.g.dart';
...
class FlickSearchResponse {
  /// Returns a new [FlickSearchResponse] instance.
  FlickSearchResponse({
    this.algoliaData,
  ...
  factory FlickSearchResponse.fromJson(Map<String, dynamic> json) =>
      _$FlickSearchResponseFromJson(json);

  Map<String, dynamic> toJson() => _$FlickSearchResponseToJson(this);
