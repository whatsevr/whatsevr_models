...
part of 'posts_photo_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PostsPhotoRowCWProxy {
  PostsPhotoRow addressLatLongWkb(String? addressLatLongWkb);

  PostsPhotoRow author(UsersRow? author);

  PostsPhotoRow community(CommunityRow? community);

  PostsPhotoRow communityUid(String? communityUid);

  PostsPhotoRow createdAt(DateTime createdAt);

  PostsPhotoRow creatorLatLongWkb(String? creatorLatLongWkb);

  PostsPhotoRow cumulativeScore(num? cumulativeScore);

  PostsPhotoRow description(String? description);

  PostsPhotoRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  PostsPhotoRow filesData(List<PostFileEntry>? filesData);

  PostsPhotoRow hashtags(List<String>? hashtags);

  PostsPhotoRow internalAiDescription(String? internalAiDescription);

  PostsPhotoRow isArchived(bool? isArchived);

  PostsPhotoRow location(String? location);

  PostsPhotoRow postCreatorType(String postCreatorType);

  PostsPhotoRow seoDataWeighted(String? seoDataWeighted);

  PostsPhotoRow taggedCommunityUids(List<String>? taggedCommunityUids);

  PostsPhotoRow taggedUserUids(List<String>? taggedUserUids);

  PostsPhotoRow title(String title);

  PostsPhotoRow totalComments(int? totalComments);

  PostsPhotoRow totalImpressions(int? totalImpressions);

  PostsPhotoRow totalReactions(int? totalReactions);

  PostsPhotoRow totalShares(int? totalShares);

  PostsPhotoRow uid(String? uid);

  PostsPhotoRow updatedAt(DateTime? updatedAt);

  PostsPhotoRow userUid(String userUid);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PostsPhotoRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PostsPhotoRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PostsPhotoRow call({
...
/// Use as `instanceOfPostsPhotoRow.copyWith(...)` or call `instanceOfPostsPhotoRow.copyWith.fieldName(value)` for a single field.
class _$PostsPhotoRowCWProxyImpl implements _$PostsPhotoRowCWProxy {
  const _$PostsPhotoRowCWProxyImpl(this._value);

  final PostsPhotoRow _value;
  ...
  @override
  PostsPhotoRow author(UsersRow? author) => call(author: author);
  ...
  @override
  PostsPhotoRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  PostsPhotoRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  PostsPhotoRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  PostsPhotoRow location(String? location) => call(location: location);
  ...
  @override
  PostsPhotoRow title(String title) => call(title: title);
  ...
  @override
  PostsPhotoRow totalShares(int? totalShares) => call(totalShares: totalShares);

  @override
  PostsPhotoRow uid(String? uid) => call(uid: uid);

  @override
  PostsPhotoRow updatedAt(DateTime? updatedAt) => call(updatedAt: updatedAt);

  @override
  PostsPhotoRow userUid(String userUid) => call(userUid: userUid);
...
extension $PostsPhotoRowCopyWith on PostsPhotoRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPostsPhotoRow.copyWith(...)` or `instanceOfPostsPhotoRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PostsPhotoRowCWProxy get copyWith => _$PostsPhotoRowCWProxyImpl(this);
}
...
PostsPhotoRow _$PostsPhotoRowFromJson(
...
Map<String, dynamic> _$PostsPhotoRowToJson(PostsPhotoRow instance) =>
    <String, dynamic>{
