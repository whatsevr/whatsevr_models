...
class FlickRow {
  /// Returns a new [FlickRow] instance.
  FlickRow({
  ...
  factory FlickRow.fromJson(Map<String, dynamic> json) =>
      _$FlickRowFromJson(json);

  Map<String, dynamic> toJson() => _$FlickRowToJson(this);
