...
part of 'posts_wtv_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PostsWtvRowCWProxy {
  PostsWtvRow addressLatLongWkb(String? addressLatLongWkb);

  PostsWtvRow author(UsersRow? author);

  PostsWtvRow community(CommunityRow? community);

  PostsWtvRow communityUid(String? communityUid);

  PostsWtvRow createdAt(DateTime createdAt);

  PostsWtvRow creatorLatLongWkb(String? creatorLatLongWkb);

  PostsWtvRow cumulativeScore(num? cumulativeScore);

  PostsWtvRow description(String? description);

  PostsWtvRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  PostsWtvRow hashtags(List<String>? hashtags);

  PostsWtvRow internalAiDescription(String? internalAiDescription);

  PostsWtvRow isArchived(bool? isArchived);

  PostsWtvRow location(String? location);

  PostsWtvRow postCreatorType(String postCreatorType);

  PostsWtvRow seoDataWeighted(String? seoDataWeighted);

  PostsWtvRow taggedCommunityUids(List<String>? taggedCommunityUids);

  PostsWtvRow taggedUserUids(List<String>? taggedUserUids);

  PostsWtvRow thumbnail(String? thumbnail);

  PostsWtvRow title(String title);

  PostsWtvRow totalComments(int? totalComments);

  PostsWtvRow totalReactions(int? totalReactions);

  PostsWtvRow totalShares(int? totalShares);

  PostsWtvRow totalViews(int? totalViews);

  PostsWtvRow uid(String uid);

  PostsWtvRow updatedAt(DateTime? updatedAt);

  PostsWtvRow userUid(String userUid);

  PostsWtvRow videoDurationInSec(int? videoDurationInSec);

  PostsWtvRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PostsWtvRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PostsWtvRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PostsWtvRow call({
...
/// Use as `instanceOfPostsWtvRow.copyWith(...)` or call `instanceOfPostsWtvRow.copyWith.fieldName(value)` for a single field.
class _$PostsWtvRowCWProxyImpl implements _$PostsWtvRowCWProxy {
  const _$PostsWtvRowCWProxyImpl(this._value);

  final PostsWtvRow _value;
  ...
  @override
  PostsWtvRow author(UsersRow? author) => call(author: author);

  @override
  PostsWtvRow community(CommunityRow? community) => call(community: community);
  ...
  @override
  PostsWtvRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  PostsWtvRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  PostsWtvRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  PostsWtvRow location(String? location) => call(location: location);
  ...
  @override
  PostsWtvRow thumbnail(String? thumbnail) => call(thumbnail: thumbnail);

  @override
  PostsWtvRow title(String title) => call(title: title);
  ...
  @override
  PostsWtvRow totalShares(int? totalShares) => call(totalShares: totalShares);

  @override
  PostsWtvRow totalViews(int? totalViews) => call(totalViews: totalViews);

  @override
  PostsWtvRow uid(String uid) => call(uid: uid);

  @override
  PostsWtvRow updatedAt(DateTime? updatedAt) => call(updatedAt: updatedAt);

  @override
  PostsWtvRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  PostsWtvRow videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $PostsWtvRowCopyWith on PostsWtvRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPostsWtvRow.copyWith(...)` or `instanceOfPostsWtvRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PostsWtvRowCWProxy get copyWith => _$PostsWtvRowCWProxyImpl(this);
}
...
PostsWtvRow _$PostsWtvRowFromJson(Map<String, dynamic> json) => $checkedCreate(
  'PostsWtvRow',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$PostsWtvRowToJson(PostsWtvRow instance) =>
    <String, dynamic>{
