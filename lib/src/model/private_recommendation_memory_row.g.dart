...
part of 'private_recommendation_memory_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PrivateRecommendationMemoryRowCWProxy {
  PrivateRecommendationMemoryRow addressLatLongWkb(String? addressLatLongWkb);

  PrivateRecommendationMemoryRow caption(String? caption);

  PrivateRecommendationMemoryRow communityUid(String? communityUid);

  PrivateRecommendationMemoryRow createdAt(DateTime createdAt);

  PrivateRecommendationMemoryRow creatorLatLongWkb(String? creatorLatLongWkb);

  PrivateRecommendationMemoryRow ctaAction(String? ctaAction);

  PrivateRecommendationMemoryRow ctaActionUrl(String? ctaActionUrl);

  PrivateRecommendationMemoryRow cumulativeScore(num? cumulativeScore);

  PrivateRecommendationMemoryRow expiresAt(DateTime? expiresAt);

  PrivateRecommendationMemoryRow hashtags(List<String>? hashtags);

  PrivateRecommendationMemoryRow imageUrl(String? imageUrl);

  PrivateRecommendationMemoryRow internalAiDescription(
    String? internalAiDescription,
  );

  PrivateRecommendationMemoryRow isActive(bool? isActive);

  PrivateRecommendationMemoryRow isArchived(bool? isArchived);

  PrivateRecommendationMemoryRow isImage(bool? isImage);

  PrivateRecommendationMemoryRow isText(bool? isText);

  PrivateRecommendationMemoryRow isVideo(bool? isVideo);

  PrivateRecommendationMemoryRow location(String? location);

  PrivateRecommendationMemoryRow postCreatorType(String postCreatorType);

  PrivateRecommendationMemoryRow seoDataWeighted(String? seoDataWeighted);

  PrivateRecommendationMemoryRow taggedCommunityUids(
    List<String>? taggedCommunityUids,
  );

  PrivateRecommendationMemoryRow taggedUserUids(List<String>? taggedUserUids);

  PrivateRecommendationMemoryRow totalComments(int? totalComments);

  PrivateRecommendationMemoryRow totalReactions(int? totalReactions);

  PrivateRecommendationMemoryRow totalShares(int? totalShares);

  PrivateRecommendationMemoryRow totalViews(int? totalViews);

  PrivateRecommendationMemoryRow uid(String? uid);

  PrivateRecommendationMemoryRow updatedAt(DateTime? updatedAt);

  PrivateRecommendationMemoryRow user(UsersRow? user);

  PrivateRecommendationMemoryRow userUid(String userUid);

  PrivateRecommendationMemoryRow videoDurationMs(int? videoDurationMs);

  PrivateRecommendationMemoryRow videoUrl(String? videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PrivateRecommendationMemoryRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PrivateRecommendationMemoryRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PrivateRecommendationMemoryRow call({
...
/// Use as `instanceOfPrivateRecommendationMemoryRow.copyWith(...)` or call `instanceOfPrivateRecommendationMemoryRow.copyWith.fieldName(value)` for a single field.
class _$PrivateRecommendationMemoryRowCWProxyImpl
    implements _$PrivateRecommendationMemoryRowCWProxy {
  const _$PrivateRecommendationMemoryRowCWProxyImpl(this._value);

  final PrivateRecommendationMemoryRow _value;
  ...
  @override
  PrivateRecommendationMemoryRow isImage(bool? isImage) =>
      call(isImage: isImage);

  @override
  PrivateRecommendationMemoryRow isText(bool? isText) => call(isText: isText);
  ...
  @override
  PrivateRecommendationMemoryRow uid(String? uid) => call(uid: uid);
  ...
  @override
  PrivateRecommendationMemoryRow user(UsersRow? user) => call(user: user);
  ...
  PrivateRecommendationMemoryRow call({
    ...
    return PrivateRecommendationMemoryRow(
...
extension $PrivateRecommendationMemoryRowCopyWith
    on PrivateRecommendationMemoryRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPrivateRecommendationMemoryRow.copyWith(...)` or `instanceOfPrivateRecommendationMemoryRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PrivateRecommendationMemoryRowCWProxy get copyWith =>
      _$PrivateRecommendationMemoryRowCWProxyImpl(this);
}
...
PrivateRecommendationMemoryRow _$PrivateRecommendationMemoryRowFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'PrivateRecommendationMemoryRow',
  json,
  ($checkedConvert) {
    $checkKeys(
      json,
    ...
    final val = PrivateRecommendationMemoryRow(
...
Map<String, dynamic> _$PrivateRecommendationMemoryRowToJson(
  PrivateRecommendationMemoryRow instance,
) => <String, dynamic>{
