...
abstract class _$ChatMessageRowCWProxy {
  ChatMessageRow clientMessageUid(String? clientMessageUid);

  ChatMessageRow communityUid(String? communityUid);

  ChatMessageRow createdAt(DateTime createdAt);

  ChatMessageRow editedAt(DateTime? editedAt);

  ChatMessageRow forwarderUserUid(String? forwarderUserUid);

  ChatMessageRow isDeleted(bool isDeleted);

  ChatMessageRow isEdited(bool? isEdited);

  ChatMessageRow isPinned(bool isPinned);

  ChatMessageRow isSystemMessage(bool isSystemMessage);

  ChatMessageRow message(String? message);

  ChatMessageRow ownerType(String ownerType);

  ChatMessageRow privateChatUid(String? privateChatUid);

  ChatMessageRow relatedContent(Object? relatedContent);

  ChatMessageRow replyToMessageUid(String? replyToMessageUid);
  ...
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `ChatMessageRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// ChatMessageRow(...).copyWith(id: 12, name: "My name")
  /// ```
  ChatMessageRow call({
...
/// Use as `instanceOfChatMessageRow.copyWith(...)` or call `instanceOfChatMessageRow.copyWith.fieldName(value)` for a single field.
class _$ChatMessageRowCWProxyImpl implements _$ChatMessageRowCWProxy {
  const _$ChatMessageRowCWProxyImpl(this._value);

  final ChatMessageRow _value;
  ...
  @override
  ChatMessageRow createdAt(DateTime createdAt) => call(createdAt: createdAt);

  @override
  ChatMessageRow editedAt(DateTime? editedAt) => call(editedAt: editedAt);
  ...
  @override
  ChatMessageRow isDeleted(bool isDeleted) => call(isDeleted: isDeleted);

  @override
  ChatMessageRow isEdited(bool? isEdited) => call(isEdited: isEdited);

  @override
  ChatMessageRow isPinned(bool isPinned) => call(isPinned: isPinned);
  ...
  @override
  ChatMessageRow message(String? message) => call(message: message);

  @override
  ChatMessageRow ownerType(String ownerType) => call(ownerType: ownerType);
...
extension $ChatMessageRowCopyWith on ChatMessageRow {
  ...
  /// Example: `instanceOfChatMessageRow.copyWith(...)` or `instanceOfChatMessageRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$ChatMessageRowCWProxy get copyWith => _$ChatMessageRowCWProxyImpl(this);
}
...
ChatMessageRow _$ChatMessageRowFromJson(
...
Map<String, dynamic> _$ChatMessageRowToJson(ChatMessageRow instance) =>
    <String, dynamic>{
