...
part 'flick_with_creator_row.g.dart';
...
class FlickWithCreatorRow {
  /// Returns a new [FlickWithCreatorRow] instance.
  FlickWithCreatorRow({
  ...
  factory FlickWithCreatorRow.fromJson(Map<String, dynamic> json) =>
      _$FlickWithCreatorRowFromJson(json);

  Map<String, dynamic> toJson() => _$FlickWithCreatorRowToJson(this);
