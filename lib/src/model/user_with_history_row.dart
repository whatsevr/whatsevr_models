...
part 'user_with_history_row.g.dart';
...
class UserWithHistoryRow {
  /// Returns a new [UserWithHistoryRow] instance.
  UserWithHistoryRow({
    this.address,
  ...
  factory UserWithHistoryRow.fromJson(Map<String, dynamic> json) =>
      _$UserWithHistoryRowFromJson(json);

  Map<String, dynamic> toJson() => _$UserWithHistoryRowToJson(this);
