...
part 'one_to_one_call_rate_info.g.dart';
...
class OneToOneCallRateInfo {
  /// Returns a new [OneToOneCallRateInfo] instance.
  OneToOneCallRateInfo({
  ...
  factory OneToOneCallRateInfo.fromJson(Map<String, dynamic> json) =>
      _$OneToOneCallRateInfoFromJson(json);

  Map<String, dynamic> toJson() => _$OneToOneCallRateInfoToJson(this);
