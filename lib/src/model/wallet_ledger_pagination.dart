...
part 'wallet_ledger_pagination.g.dart';
...
class WalletLedgerPagination {
  /// Returns a new [WalletLedgerPagination] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is WalletLedgerPagination &&
  ...
  factory WalletLedgerPagination.fromJson(Map<String, dynamic> json) =>
      _$WalletLedgerPaginationFromJson(json);

  Map<String, dynamic> toJson() => _$WalletLedgerPaginationToJson(this);
