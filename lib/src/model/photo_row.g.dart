...
part of 'photo_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PhotoRowCWProxy {
  PhotoRow addressLatLongWkb(String? addressLatLongWkb);

  PhotoRow communityUid(String? communityUid);

  PhotoRow createdAt(DateTime createdAt);

  PhotoRow creatorLatLongWkb(String? creatorLatLongWkb);

  PhotoRow cumulativeScore(num? cumulativeScore);

  PhotoRow description(String? description);

  PhotoRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  PhotoRow filesData(List<PostFileEntry>? filesData);

  PhotoRow hashtags(List<String>? hashtags);

  PhotoRow internalAiDescription(String? internalAiDescription);

  PhotoRow isArchived(bool? isArchived);

  PhotoRow location(String? location);

  PhotoRow postCreatorType(String postCreatorType);

  PhotoRow seoDataWeighted(String? seoDataWeighted);

  PhotoRow taggedCommunityUids(List<String>? taggedCommunityUids);

  PhotoRow taggedUserUids(List<String>? taggedUserUids);

  PhotoRow title(String title);

  PhotoRow totalComments(int? totalComments);

  PhotoRow totalImpressions(int? totalImpressions);

  PhotoRow totalReactions(int? totalReactions);
  ...
  PhotoRow userUid(String userUid);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PhotoRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PhotoRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PhotoRow call({
...
/// Use as `instanceOfPhotoRow.copyWith(...)` or call `instanceOfPhotoRow.copyWith.fieldName(value)` for a single field.
class _$PhotoRowCWProxyImpl implements _$PhotoRowCWProxy {
  const _$PhotoRowCWProxyImpl(this._value);

  final PhotoRow _value;
  ...
  @override
  PhotoRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  PhotoRow description(String? description) => call(description: description);
  ...
  @override
  PhotoRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  PhotoRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  PhotoRow location(String? location) => call(location: location);
  ...
  @override
  PhotoRow title(String title) => call(title: title);
  ...
  @override
  PhotoRow userUid(String userUid) => call(userUid: userUid);
...
extension $PhotoRowCopyWith on PhotoRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPhotoRow.copyWith(...)` or `instanceOfPhotoRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PhotoRowCWProxy get copyWith => _$PhotoRowCWProxyImpl(this);
}
...
PhotoRow _$PhotoRowFromJson(Map<String, dynamic> json) => $checkedCreate(
  'PhotoRow',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$PhotoRowToJson(PhotoRow instance) => <String, dynamic>{
