...
class PostsOfferRow {
  /// Returns a new [PostsOfferRow] instance.
  PostsOfferRow({
    this.author,
  ...
  factory PostsOfferRow.fromJson(Map<String, dynamic> json) =>
      _$PostsOfferRowFromJson(json);

  Map<String, dynamic> toJson() => _$PostsOfferRowToJson(this);
