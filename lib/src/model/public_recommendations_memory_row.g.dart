...
part of 'public_recommendations_memory_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PublicRecommendationsMemoryRowCWProxy {
  PublicRecommendationsMemoryRow addressLatLongWkb(String? addressLatLongWkb);

  PublicRecommendationsMemoryRow caption(String? caption);

  PublicRecommendationsMemoryRow communityUid(String? communityUid);

  PublicRecommendationsMemoryRow createdAt(DateTime createdAt);

  PublicRecommendationsMemoryRow creatorLatLongWkb(String? creatorLatLongWkb);

  PublicRecommendationsMemoryRow ctaAction(String? ctaAction);

  PublicRecommendationsMemoryRow ctaActionUrl(String? ctaActionUrl);

  PublicRecommendationsMemoryRow cumulativeScore(num? cumulativeScore);

  PublicRecommendationsMemoryRow expiresAt(DateTime? expiresAt);

  PublicRecommendationsMemoryRow hashtags(List<String>? hashtags);

  PublicRecommendationsMemoryRow imageUrl(String? imageUrl);

  PublicRecommendationsMemoryRow internalAiDescription(
    String? internalAiDescription,
  );

  PublicRecommendationsMemoryRow isActive(bool? isActive);

  PublicRecommendationsMemoryRow isArchived(bool? isArchived);

  PublicRecommendationsMemoryRow isImage(bool? isImage);

  PublicRecommendationsMemoryRow isText(bool? isText);

  PublicRecommendationsMemoryRow isVideo(bool? isVideo);

  PublicRecommendationsMemoryRow location(String? location);

  PublicRecommendationsMemoryRow postCreatorType(String postCreatorType);

  PublicRecommendationsMemoryRow seoDataWeighted(String? seoDataWeighted);

  PublicRecommendationsMemoryRow taggedCommunityUids(
    List<String>? taggedCommunityUids,
  );

  PublicRecommendationsMemoryRow taggedUserUids(List<String>? taggedUserUids);

  PublicRecommendationsMemoryRow totalComments(int? totalComments);

  PublicRecommendationsMemoryRow totalReactions(int? totalReactions);

  PublicRecommendationsMemoryRow totalShares(int? totalShares);
  ...
  PublicRecommendationsMemoryRow user(UsersRow? user);

  PublicRecommendationsMemoryRow userUid(String userUid);

  PublicRecommendationsMemoryRow videoDurationMs(int? videoDurationMs);

  PublicRecommendationsMemoryRow videoUrl(String? videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PublicRecommendationsMemoryRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PublicRecommendationsMemoryRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PublicRecommendationsMemoryRow call({
...
/// Use as `instanceOfPublicRecommendationsMemoryRow.copyWith(...)` or call `instanceOfPublicRecommendationsMemoryRow.copyWith.fieldName(value)` for a single field.
class _$PublicRecommendationsMemoryRowCWProxyImpl
    implements _$PublicRecommendationsMemoryRowCWProxy {
  const _$PublicRecommendationsMemoryRowCWProxyImpl(this._value);

  final PublicRecommendationsMemoryRow _value;
  ...
  @override
  PublicRecommendationsMemoryRow isText(bool? isText) => call(isText: isText);
  ...
  @override
  PublicRecommendationsMemoryRow user(UsersRow? user) => call(user: user);
  ...
  PublicRecommendationsMemoryRow call({
    ...
    return PublicRecommendationsMemoryRow(
...
extension $PublicRecommendationsMemoryRowCopyWith
    on PublicRecommendationsMemoryRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPublicRecommendationsMemoryRow.copyWith(...)` or `instanceOfPublicRecommendationsMemoryRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PublicRecommendationsMemoryRowCWProxy get copyWith =>
      _$PublicRecommendationsMemoryRowCWProxyImpl(this);
}
...
PublicRecommendationsMemoryRow _$PublicRecommendationsMemoryRowFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'PublicRecommendationsMemoryRow',
  json,
  ($checkedConvert) {
    $checkKeys(
      json,
...
Map<String, dynamic> _$PublicRecommendationsMemoryRowToJson(
  PublicRecommendationsMemoryRow instance,
) => <String, dynamic>{
