...
part of 'external_search_flick_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$ExternalSearchFlickRowCWProxy {
  ExternalSearchFlickRow addressLatLongWkb(String? addressLatLongWkb);

  ExternalSearchFlickRow communityUid(String? communityUid);

  ExternalSearchFlickRow createdAt(DateTime createdAt);

  ExternalSearchFlickRow creator(CreatorInfo? creator);

  ExternalSearchFlickRow creatorLatLongWkb(String? creatorLatLongWkb);

  ExternalSearchFlickRow cumulativeScore(num? cumulativeScore);

  ExternalSearchFlickRow description(String? description);

  ExternalSearchFlickRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  );

  ExternalSearchFlickRow hashtags(List<String>? hashtags);

  ExternalSearchFlickRow internalAiDescription(String? internalAiDescription);

  ExternalSearchFlickRow isArchived(bool? isArchived);

  ExternalSearchFlickRow location(String? location);

  ExternalSearchFlickRow optimizedFiles(Object optimizedFiles);

  ExternalSearchFlickRow postCreatorType(String postCreatorType);

  ExternalSearchFlickRow relatedContentUid(String? relatedContentUid);

  ExternalSearchFlickRow seoDataWeighted(String? seoDataWeighted);

  ExternalSearchFlickRow taggedCommunityUids(List<String>? taggedCommunityUids);

  ExternalSearchFlickRow taggedUserUids(List<String>? taggedUserUids);

  ExternalSearchFlickRow thumbnail(String? thumbnail);

  ExternalSearchFlickRow title(String title);

  ExternalSearchFlickRow totalComments(int? totalComments);

  ExternalSearchFlickRow totalReactions(int? totalReactions);

  ExternalSearchFlickRow totalShares(int? totalShares);
  ...
  ExternalSearchFlickRow userUid(String userUid);

  ExternalSearchFlickRow videoDurationInSec(int? videoDurationInSec);

  ExternalSearchFlickRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `ExternalSearchFlickRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// ExternalSearchFlickRow(...).copyWith(id: 12, name: "My name")
  /// ```
  ExternalSearchFlickRow call({
...
/// Use as `instanceOfExternalSearchFlickRow.copyWith(...)` or call `instanceOfExternalSearchFlickRow.copyWith.fieldName(value)` for a single field.
class _$ExternalSearchFlickRowCWProxyImpl
    implements _$ExternalSearchFlickRowCWProxy {
  const _$ExternalSearchFlickRowCWProxyImpl(this._value);

  final ExternalSearchFlickRow _value;
  ...
  @override
  ExternalSearchFlickRow location(String? location) => call(location: location);
  ...
  @override
  ExternalSearchFlickRow taggedCommunityUids(
    List<String>? taggedCommunityUids,
  ...
  @override
  ExternalSearchFlickRow title(String title) => call(title: title);
  ...
  @override
  ExternalSearchFlickRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  ExternalSearchFlickRow videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $ExternalSearchFlickRowCopyWith on ExternalSearchFlickRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfExternalSearchFlickRow.copyWith(...)` or `instanceOfExternalSearchFlickRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$ExternalSearchFlickRowCWProxy get copyWith =>
      _$ExternalSearchFlickRowCWProxyImpl(this);
}
...
ExternalSearchFlickRow _$ExternalSearchFlickRowFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'ExternalSearchFlickRow',
  json,
  ($checkedConvert) {
    $checkKeys(
      json,
    ...
    final val = ExternalSearchFlickRow(
...
Map<String, dynamic> _$ExternalSearchFlickRowToJson(
  ExternalSearchFlickRow instance,
) => <String, dynamic>{
