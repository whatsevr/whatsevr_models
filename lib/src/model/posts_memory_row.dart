...
class PostsMemoryRow {
  /// Returns a new [PostsMemoryRow] instance.
  PostsMemoryRow({
  ...
  factory PostsMemoryRow.fromJson(Map<String, dynamic> json) =>
      _$PostsMemoryRowFromJson(json);

  Map<String, dynamic> toJson() => _$PostsMemoryRowToJson(this);
