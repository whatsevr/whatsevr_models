...
class RelatedPhotoRow {
  /// Returns a new [RelatedPhotoRow] instance.
  RelatedPhotoRow({
  ...
  factory RelatedPhotoRow.fromJson(Map<String, dynamic> json) =>
      _$RelatedPhotoRowFromJson(json);

  Map<String, dynamic> toJson() => _$RelatedPhotoRowToJson(this);
