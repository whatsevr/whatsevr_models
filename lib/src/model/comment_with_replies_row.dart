...
part 'comment_with_replies_row.g.dart';
...
class CommentWithRepliesRow {
  /// Returns a new [CommentWithRepliesRow] instance.
  ...
  @JsonKey(name: r'comment_replies', required: true, includeIfNull: false)
  final List<CommentReplyWithAuthorRow> commentReplies;
  ...
  bool operator ==(Object other) =>
      ...
      other is CommentWithRepliesRow &&
          other.author == author &&
  ...
  factory CommentWithRepliesRow.fromJson(Map<String, dynamic> json) =>
      _$CommentWithRepliesRowFromJson(json);

  Map<String, dynamic> toJson() => _$CommentWithRepliesRowToJson(this);
