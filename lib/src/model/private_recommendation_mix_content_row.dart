...
part 'private_recommendation_mix_content_row.g.dart';
...
class PrivateRecommendationMixContentRow {
  /// Returns a new [PrivateRecommendationMixContentRow] instance.
  ...
  @JsonKey(name: r'optimized_files', required: false, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is PrivateRecommendationMixContentRow &&
  ...
  int get hashCode =>
      ...
      (optimizedFiles == null ? 0 : optimizedFiles.hashCode) +
  ...
  factory PrivateRecommendationMixContentRow.fromJson(
    Map<String, dynamic> json,
  ) => _$PrivateRecommendationMixContentRowFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PrivateRecommendationMixContentRowToJson(this);
