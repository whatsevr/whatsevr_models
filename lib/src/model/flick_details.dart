...
class FlickDetails {
  /// Returns a new [FlickDetails] instance.
  FlickDetails({
  ...
  final List<PostDetailsCommentRow> comments;
  ...
  factory FlickDetails.fromJson(Map<String, dynamic> json) =>
      _$FlickDetailsFromJson(json);

  Map<String, dynamic> toJson() => _$FlickDetailsToJson(this);
