...
part of 'posts_memory_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PostsMemoryRowCWProxy {
  PostsMemoryRow addressLatLongWkb(String? addressLatLongWkb);

  PostsMemoryRow author(UsersRow? author);

  PostsMemoryRow caption(String? caption);

  PostsMemoryRow community(CommunityRow? community);

  PostsMemoryRow communityUid(String? communityUid);

  PostsMemoryRow createdAt(DateTime createdAt);

  PostsMemoryRow creatorLatLongWkb(String? creatorLatLongWkb);

  PostsMemoryRow ctaAction(String? ctaAction);

  PostsMemoryRow ctaActionUrl(String? ctaActionUrl);

  PostsMemoryRow cumulativeScore(num? cumulativeScore);

  PostsMemoryRow expiresAt(DateTime? expiresAt);

  PostsMemoryRow hashtags(List<String>? hashtags);

  PostsMemoryRow imageUrl(String? imageUrl);

  PostsMemoryRow internalAiDescription(String? internalAiDescription);

  PostsMemoryRow isActive(bool? isActive);

  PostsMemoryRow isArchived(bool? isArchived);

  PostsMemoryRow isImage(bool? isImage);

  PostsMemoryRow isText(bool? isText);

  PostsMemoryRow isVideo(bool? isVideo);

  PostsMemoryRow location(String? location);

  PostsMemoryRow postCreatorType(String postCreatorType);

  PostsMemoryRow seoDataWeighted(String? seoDataWeighted);

  PostsMemoryRow taggedCommunityUids(List<String>? taggedCommunityUids);

  PostsMemoryRow taggedUserUids(List<String>? taggedUserUids);

  PostsMemoryRow totalComments(int? totalComments);

  PostsMemoryRow totalReactions(int? totalReactions);

  PostsMemoryRow totalShares(int? totalShares);

  PostsMemoryRow totalViews(int? totalViews);

  PostsMemoryRow uid(String? uid);

  PostsMemoryRow updatedAt(DateTime? updatedAt);

  PostsMemoryRow userUid(String userUid);

  PostsMemoryRow videoDurationMs(int? videoDurationMs);

  PostsMemoryRow videoUrl(String? videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PostsMemoryRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PostsMemoryRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PostsMemoryRow call({
...
/// Use as `instanceOfPostsMemoryRow.copyWith(...)` or call `instanceOfPostsMemoryRow.copyWith.fieldName(value)` for a single field.
class _$PostsMemoryRowCWProxyImpl implements _$PostsMemoryRowCWProxy {
  const _$PostsMemoryRowCWProxyImpl(this._value);

  final PostsMemoryRow _value;
  ...
  @override
  PostsMemoryRow author(UsersRow? author) => call(author: author);

  @override
  PostsMemoryRow caption(String? caption) => call(caption: caption);
  ...
  @override
  PostsMemoryRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  PostsMemoryRow ctaAction(String? ctaAction) => call(ctaAction: ctaAction);
  ...
  @override
  PostsMemoryRow expiresAt(DateTime? expiresAt) => call(expiresAt: expiresAt);

  @override
  PostsMemoryRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);

  @override
  PostsMemoryRow imageUrl(String? imageUrl) => call(imageUrl: imageUrl);
  ...
  @override
  PostsMemoryRow isActive(bool? isActive) => call(isActive: isActive);

  @override
  PostsMemoryRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  PostsMemoryRow isImage(bool? isImage) => call(isImage: isImage);

  @override
  PostsMemoryRow isText(bool? isText) => call(isText: isText);

  @override
  PostsMemoryRow isVideo(bool? isVideo) => call(isVideo: isVideo);

  @override
  PostsMemoryRow location(String? location) => call(location: location);
  ...
  @override
  PostsMemoryRow totalViews(int? totalViews) => call(totalViews: totalViews);

  @override
  PostsMemoryRow uid(String? uid) => call(uid: uid);

  @override
  PostsMemoryRow updatedAt(DateTime? updatedAt) => call(updatedAt: updatedAt);

  @override
  PostsMemoryRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  PostsMemoryRow videoUrl(String? videoUrl) => call(videoUrl: videoUrl);
  ...
  PostsMemoryRow call({
    ...
    Object? isText = const $CopyWithPlaceholder(),
    ...
    return PostsMemoryRow(
      ...
      isImage: isImage == const $CopyWithPlaceholder()
          ...
          // ignore: cast_nullable_to_non_nullable
          : isImage as bool?,
      isText: isText == const $CopyWithPlaceholder()
          ? _value.isText
          // ignore: cast_nullable_to_non_nullable
          : isText as bool?,
...
extension $PostsMemoryRowCopyWith on PostsMemoryRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPostsMemoryRow.copyWith(...)` or `instanceOfPostsMemoryRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PostsMemoryRowCWProxy get copyWith => _$PostsMemoryRowCWProxyImpl(this);
}
...
PostsMemoryRow _$PostsMemoryRowFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = PostsMemoryRow(
      ...
      isText: $checkedConvert('is_text', (v) => v as bool?),
...
Map<String, dynamic> _$PostsMemoryRowToJson(PostsMemoryRow instance) =>
    <String, dynamic>{
