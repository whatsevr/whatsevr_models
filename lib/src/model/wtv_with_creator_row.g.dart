...
part of 'wtv_with_creator_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$WtvWithCreatorRowCWProxy {
  WtvWithCreatorRow addressLatLongWkb(String? addressLatLongWkb);

  WtvWithCreatorRow communityUid(String? communityUid);

  WtvWithCreatorRow createdAt(DateTime createdAt);

  WtvWithCreatorRow creator(UsersRow? creator);

  WtvWithCreatorRow creatorLatLongWkb(String? creatorLatLongWkb);

  WtvWithCreatorRow cumulativeScore(num? cumulativeScore);

  WtvWithCreatorRow description(String? description);

  WtvWithCreatorRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  WtvWithCreatorRow hashtags(List<String>? hashtags);

  WtvWithCreatorRow internalAiDescription(String? internalAiDescription);

  WtvWithCreatorRow isArchived(bool? isArchived);

  WtvWithCreatorRow location(String? location);

  WtvWithCreatorRow postCreatorType(String postCreatorType);

  WtvWithCreatorRow seoDataWeighted(String? seoDataWeighted);

  WtvWithCreatorRow taggedCommunityUids(List<String>? taggedCommunityUids);

  WtvWithCreatorRow taggedUserUids(List<String>? taggedUserUids);

  WtvWithCreatorRow thumbnail(String? thumbnail);

  WtvWithCreatorRow title(String title);

  WtvWithCreatorRow totalComments(int? totalComments);

  WtvWithCreatorRow totalReactions(int? totalReactions);

  WtvWithCreatorRow totalShares(int? totalShares);
  ...
  WtvWithCreatorRow userUid(String userUid);

  WtvWithCreatorRow videoDurationInSec(int? videoDurationInSec);

  WtvWithCreatorRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `WtvWithCreatorRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// WtvWithCreatorRow(...).copyWith(id: 12, name: "My name")
  /// ```
  WtvWithCreatorRow call({
...
/// Use as `instanceOfWtvWithCreatorRow.copyWith(...)` or call `instanceOfWtvWithCreatorRow.copyWith.fieldName(value)` for a single field.
class _$WtvWithCreatorRowCWProxyImpl implements _$WtvWithCreatorRowCWProxy {
  const _$WtvWithCreatorRowCWProxyImpl(this._value);

  final WtvWithCreatorRow _value;
  ...
  @override
  WtvWithCreatorRow createdAt(DateTime createdAt) => call(createdAt: createdAt);

  @override
  WtvWithCreatorRow creator(UsersRow? creator) => call(creator: creator);
  ...
  @override
  WtvWithCreatorRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  ...
  @override
  WtvWithCreatorRow location(String? location) => call(location: location);
  ...
  @override
  WtvWithCreatorRow thumbnail(String? thumbnail) => call(thumbnail: thumbnail);

  @override
  WtvWithCreatorRow title(String title) => call(title: title);
  ...
  @override
  WtvWithCreatorRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  WtvWithCreatorRow videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $WtvWithCreatorRowCopyWith on WtvWithCreatorRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfWtvWithCreatorRow.copyWith(...)` or `instanceOfWtvWithCreatorRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$WtvWithCreatorRowCWProxy get copyWith =>
      _$WtvWithCreatorRowCWProxyImpl(this);
}
...
WtvWithCreatorRow _$WtvWithCreatorRowFromJson(
...
Map<String, dynamic> _$WtvWithCreatorRowToJson(WtvWithCreatorRow instance) =>
    <String, dynamic>{
