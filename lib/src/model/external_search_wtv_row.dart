...
part 'external_search_wtv_row.g.dart';
...
class ExternalSearchWtvRow {
  /// Returns a new [ExternalSearchWtvRow] instance.
  ...
  factory ExternalSearchWtvRow.fromJson(Map<String, dynamic> json) =>
      _$ExternalSearchWtvRowFromJson(json);

  Map<String, dynamic> toJson() => _$ExternalSearchWtvRowToJson(this);
