...
part of 'reply_chat_message_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$ReplyChatMessageRowCWProxy {
  ReplyChatMessageRow clientMessageUid(String? clientMessageUid);

  ReplyChatMessageRow communityUid(String? communityUid);

  ReplyChatMessageRow createdAt(DateTime createdAt);

  ReplyChatMessageRow editedAt(DateTime? editedAt);

  ReplyChatMessageRow forwarderUserUid(String? forwarderUserUid);

  ReplyChatMessageRow isDeleted(bool isDeleted);

  ReplyChatMessageRow isEdited(bool? isEdited);

  ReplyChatMessageRow isPinned(bool isPinned);

  ReplyChatMessageRow isSystemMessage(bool isSystemMessage);

  ReplyChatMessageRow message(String? message);

  ReplyChatMessageRow ownerType(String ownerType);

  ReplyChatMessageRow privateChatUid(String? privateChatUid);

  ReplyChatMessageRow relatedContent(Object? relatedContent);

  ReplyChatMessageRow replyToMessageUid(String? replyToMessageUid);

  ReplyChatMessageRow sender(PublicUser? sender);
  ...
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `ReplyChatMessageRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// ReplyChatMessageRow(...).copyWith(id: 12, name: "My name")
  /// ```
  ReplyChatMessageRow call({
...
/// Use as `instanceOfReplyChatMessageRow.copyWith(...)` or call `instanceOfReplyChatMessageRow.copyWith.fieldName(value)` for a single field.
class _$ReplyChatMessageRowCWProxyImpl implements _$ReplyChatMessageRowCWProxy {
  const _$ReplyChatMessageRowCWProxyImpl(this._value);

  final ReplyChatMessageRow _value;
  ...
  @override
  ReplyChatMessageRow editedAt(DateTime? editedAt) => call(editedAt: editedAt);
  ...
  @override
  ReplyChatMessageRow isDeleted(bool isDeleted) => call(isDeleted: isDeleted);

  @override
  ReplyChatMessageRow isEdited(bool? isEdited) => call(isEdited: isEdited);

  @override
  ReplyChatMessageRow isPinned(bool isPinned) => call(isPinned: isPinned);
  ...
  @override
  ReplyChatMessageRow message(String? message) => call(message: message);

  @override
  ReplyChatMessageRow ownerType(String ownerType) => call(ownerType: ownerType);
  ...
  @override
  ReplyChatMessageRow sender(PublicUser? sender) => call(sender: sender);
...
extension $ReplyChatMessageRowCopyWith on ReplyChatMessageRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfReplyChatMessageRow.copyWith(...)` or `instanceOfReplyChatMessageRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$ReplyChatMessageRowCWProxy get copyWith =>
      _$ReplyChatMessageRowCWProxyImpl(this);
}
...
ReplyChatMessageRow _$ReplyChatMessageRowFromJson(
...
Map<String, dynamic> _$ReplyChatMessageRowToJson(
  ReplyChatMessageRow instance,
) => <String, dynamic>{
