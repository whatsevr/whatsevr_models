...
part 'tagged_content_row.g.dart';
...
class TaggedContentRow {
  /// Returns a new [TaggedContentRow] instance.
  TaggedContentRow({
  ...
  factory TaggedContentRow.fromJson(Map<String, dynamic> json) =>
      _$TaggedContentRowFromJson(json);

  Map<String, dynamic> toJson() => _$TaggedContentRowToJson(this);
