...
part 'chat_message_with_replies_row.g.dart';
...
class ChatMessageWithRepliesRow {
  /// Returns a new [ChatMessageWithRepliesRow] instance.
  ChatMessageWithRepliesRow({
    ...
    required this.replyToChatMessage,
  ...
  @JsonKey(name: r'reply_to_chat_message', required: true, includeIfNull: false)
  final List<ReplyChatMessageRow> replyToChatMessage;
  ...
  bool operator ==(Object other) =>
      ...
      other is ChatMessageWithRepliesRow &&
  ...
  factory ChatMessageWithRepliesRow.fromJson(Map<String, dynamic> json) =>
      _$ChatMessageWithRepliesRowFromJson(json);

  Map<String, dynamic> toJson() => _$ChatMessageWithRepliesRowToJson(this);
