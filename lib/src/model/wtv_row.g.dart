...
part of 'wtv_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$WtvRowCWProxy {
  WtvRow addressLatLongWkb(String? addressLatLongWkb);

  WtvRow communityUid(String? communityUid);

  WtvRow createdAt(DateTime createdAt);

  WtvRow creatorLatLongWkb(String? creatorLatLongWkb);

  WtvRow cumulativeScore(num? cumulativeScore);

  WtvRow description(String? description);

  WtvRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  WtvRow hashtags(List<String>? hashtags);

  WtvRow internalAiDescription(String? internalAiDescription);

  WtvRow isArchived(bool? isArchived);

  WtvRow location(String? location);

  WtvRow postCreatorType(String postCreatorType);

  WtvRow seoDataWeighted(String? seoDataWeighted);

  WtvRow taggedCommunityUids(List<String>? taggedCommunityUids);

  WtvRow taggedUserUids(List<String>? taggedUserUids);

  WtvRow thumbnail(String? thumbnail);

  WtvRow title(String title);

  WtvRow totalComments(int? totalComments);

  WtvRow totalReactions(int? totalReactions);

  WtvRow totalShares(int? totalShares);
  ...
  WtvRow userUid(String userUid);

  WtvRow videoDurationInSec(int? videoDurationInSec);

  WtvRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `WtvRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// WtvRow(...).copyWith(id: 12, name: "My name")
  /// ```
  WtvRow call({
...
/// Use as `instanceOfWtvRow.copyWith(...)` or call `instanceOfWtvRow.copyWith.fieldName(value)` for a single field.
class _$WtvRowCWProxyImpl implements _$WtvRowCWProxy {
  const _$WtvRowCWProxyImpl(this._value);
  ...
  @override
  WtvRow communityUid(String? communityUid) => call(communityUid: communityUid);

  @override
  WtvRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  WtvRow description(String? description) => call(description: description);
  ...
  @override
  WtvRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  WtvRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  WtvRow location(String? location) => call(location: location);
  ...
  @override
  WtvRow thumbnail(String? thumbnail) => call(thumbnail: thumbnail);

  @override
  WtvRow title(String title) => call(title: title);
  ...
  @override
  WtvRow totalShares(int? totalShares) => call(totalShares: totalShares);
  ...
  @override
  WtvRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  WtvRow videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $WtvRowCopyWith on WtvRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfWtvRow.copyWith(...)` or `instanceOfWtvRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$WtvRowCWProxy get copyWith => _$WtvRowCWProxyImpl(this);
}
...
WtvRow _$WtvRowFromJson(Map<String, dynamic> json) => $checkedCreate(
  'WtvRow',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$WtvRowToJson(WtvRow instance) => <String, dynamic>{
