...
part 'public_recommendations_wtv_row.g.dart';
...
class PublicRecommendationsWtvRow {
  /// Returns a new [PublicRecommendationsWtvRow] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is PublicRecommendationsWtvRow &&
  ...
  factory PublicRecommendationsWtvRow.fromJson(Map<String, dynamic> json) =>
      _$PublicRecommendationsWtvRowFromJson(json);

  Map<String, dynamic> toJson() => _$PublicRecommendationsWtvRowToJson(this);
