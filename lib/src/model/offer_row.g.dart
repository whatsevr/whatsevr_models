...
part of 'offer_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$OfferRowCWProxy {
  OfferRow communityUid(String? communityUid);

  OfferRow createdAt(DateTime createdAt);

  OfferRow creatorLatLongWkb(String? creatorLatLongWkb);

  OfferRow ctaAction(String? ctaAction);

  OfferRow ctaActionUrl(String? ctaActionUrl);

  OfferRow cumulativeScore(num? cumulativeScore);

  OfferRow description(String description);

  OfferRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  OfferRow filesData(List<PostFileEntry>? filesData);

  OfferRow hashtags(List<String>? hashtags);

  OfferRow internalAiDescription(String? internalAiDescription);

  OfferRow isActive(bool? isActive);

  OfferRow isArchived(bool? isArchived);

  OfferRow isDeleted(bool? isDeleted);

  OfferRow postCreatorType(String postCreatorType);

  OfferRow richDescription(Map<String, Object>? richDescription);

  OfferRow seoDataWeighted(String? seoDataWeighted);

  OfferRow status(String status);

  OfferRow taggedCommunityUids(List<String>? taggedCommunityUids);

  OfferRow taggedUserUids(List<String>? taggedUserUids);

  OfferRow targetAreas(List<String>? targetAreas);

  OfferRow targetGender(String? targetGender);

  OfferRow title(String? title);

  OfferRow totalComments(int? totalComments);

  OfferRow totalImpressions(int? totalImpressions);

  OfferRow totalReactions(int? totalReactions);
  ...
  OfferRow userUid(String userUid);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `OfferRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// OfferRow(...).copyWith(id: 12, name: "My name")
  /// ```
  OfferRow call({
    String? communityUid,
    DateTime createdAt,
...
/// Use as `instanceOfOfferRow.copyWith(...)` or call `instanceOfOfferRow.copyWith.fieldName(value)` for a single field.
class _$OfferRowCWProxyImpl implements _$OfferRowCWProxy {
  const _$OfferRowCWProxyImpl(this._value);

  final OfferRow _value;
  ...
  @override
  OfferRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  OfferRow ctaAction(String? ctaAction) => call(ctaAction: ctaAction);
  ...
  @override
  OfferRow description(String description) => call(description: description);
  ...
  @override
  OfferRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  OfferRow isActive(bool? isActive) => call(isActive: isActive);

  @override
  OfferRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  OfferRow isDeleted(bool? isDeleted) => call(isDeleted: isDeleted);
  ...
  @override
  OfferRow status(String status) => call(status: status);
  ...
  @override
  OfferRow title(String? title) => call(title: title);
  ...
  @override
  OfferRow userUid(String userUid) => call(userUid: userUid);
...
extension $OfferRowCopyWith on OfferRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfOfferRow.copyWith(...)` or `instanceOfOfferRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$OfferRowCWProxy get copyWith => _$OfferRowCWProxyImpl(this);
}
...
OfferRow _$OfferRowFromJson(Map<String, dynamic> json) => $checkedCreate(
  'OfferRow',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$OfferRowToJson(OfferRow instance) => <String, dynamic>{
