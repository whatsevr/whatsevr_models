...
part of 'posts_mix_content_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PostsMixContentRowCWProxy {
  PostsMixContentRow addressLatLongWkb(String? addressLatLongWkb);

  PostsMixContentRow author(UsersRow? author);

  PostsMixContentRow community(CommunityRow? community);

  PostsMixContentRow communityUid(String? communityUid);

  PostsMixContentRow createdAt(DateTime createdAt);

  PostsMixContentRow creatorLatLongWkb(String? creatorLatLongWkb);

  PostsMixContentRow ctaAction(String? ctaAction);

  PostsMixContentRow ctaActionUrl(String? ctaActionUrl);

  PostsMixContentRow cumulativeScore(num? cumulativeScore);

  PostsMixContentRow description(String? description);

  PostsMixContentRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  PostsMixContentRow filesData(List<PostFileEntry>? filesData);

  PostsMixContentRow hashtags(List<String>? hashtags);

  PostsMixContentRow internalAiDescription(String? internalAiDescription);

  PostsMixContentRow isActive(bool? isActive);

  PostsMixContentRow isArchived(bool? isArchived);

  PostsMixContentRow isDeleted(bool? isDeleted);

  PostsMixContentRow location(String? location);

  PostsMixContentRow optimizedFiles(Object? optimizedFiles);

  PostsMixContentRow postCreatorType(String postCreatorType);
  ...
  PostsMixContentRow status(String? status);

  PostsMixContentRow taggedCommunityUids(List<String>? taggedCommunityUids);

  PostsMixContentRow taggedUserUids(List<String>? taggedUserUids);

  PostsMixContentRow targetAreas(List<String>? targetAreas);

  PostsMixContentRow targetGender(String? targetGender);

  PostsMixContentRow thumbnail(String? thumbnail);

  PostsMixContentRow title(String? title);

  PostsMixContentRow totalComments(int? totalComments);

  PostsMixContentRow totalImpressions(int? totalImpressions);

  PostsMixContentRow totalReactions(int? totalReactions);

  PostsMixContentRow totalShares(int? totalShares);
  ...
  PostsMixContentRow user(UsersRow? user);

  PostsMixContentRow userUid(String userUid);

  PostsMixContentRow videoDurationInSec(int? videoDurationInSec);

  PostsMixContentRow videoUrl(String? videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PostsMixContentRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PostsMixContentRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PostsMixContentRow call({
...
/// Use as `instanceOfPostsMixContentRow.copyWith(...)` or call `instanceOfPostsMixContentRow.copyWith.fieldName(value)` for a single field.
class _$PostsMixContentRowCWProxyImpl implements _$PostsMixContentRowCWProxy {
  const _$PostsMixContentRowCWProxyImpl(this._value);

  final PostsMixContentRow _value;
  ...
  @override
  PostsMixContentRow author(UsersRow? author) => call(author: author);
  ...
  @override
  PostsMixContentRow ctaAction(String? ctaAction) => call(ctaAction: ctaAction);
  ...
  @override
  PostsMixContentRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  ...
  @override
  PostsMixContentRow isActive(bool? isActive) => call(isActive: isActive);
  ...
  @override
  PostsMixContentRow isDeleted(bool? isDeleted) => call(isDeleted: isDeleted);

  @override
  PostsMixContentRow location(String? location) => call(location: location);
  ...
  @override
  PostsMixContentRow status(String? status) => call(status: status);
  ...
  @override
  PostsMixContentRow thumbnail(String? thumbnail) => call(thumbnail: thumbnail);

  @override
  PostsMixContentRow title(String? title) => call(title: title);
  ...
  @override
  PostsMixContentRow user(UsersRow? user) => call(user: user);

  @override
  PostsMixContentRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  PostsMixContentRow videoUrl(String? videoUrl) => call(videoUrl: videoUrl);
...
extension $PostsMixContentRowCopyWith on PostsMixContentRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPostsMixContentRow.copyWith(...)` or `instanceOfPostsMixContentRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PostsMixContentRowCWProxy get copyWith =>
      _$PostsMixContentRowCWProxyImpl(this);
}
...
PostsMixContentRow _$PostsMixContentRowFromJson(
...
Map<String, dynamic> _$PostsMixContentRowToJson(PostsMixContentRow instance) =>
    <String, dynamic>{
