...
part 'private_recommendation_memory_row.g.dart';
...
class PrivateRecommendationMemoryRow {
  /// Returns a new [PrivateRecommendationMemoryRow] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is PrivateRecommendationMemoryRow &&
  ...
  factory PrivateRecommendationMemoryRow.fromJson(Map<String, dynamic> json) =>
      _$PrivateRecommendationMemoryRowFromJson(json);

  Map<String, dynamic> toJson() => _$PrivateRecommendationMemoryRowToJson(this);
