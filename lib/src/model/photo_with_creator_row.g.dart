...
part of 'photo_with_creator_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PhotoWithCreatorRowCWProxy {
  PhotoWithCreatorRow addressLatLongWkb(String? addressLatLongWkb);

  PhotoWithCreatorRow communityUid(String? communityUid);

  PhotoWithCreatorRow createdAt(DateTime createdAt);

  PhotoWithCreatorRow creator(UsersRow? creator);

  PhotoWithCreatorRow creatorLatLongWkb(String? creatorLatLongWkb);

  PhotoWithCreatorRow cumulativeScore(num? cumulativeScore);

  PhotoWithCreatorRow description(String? description);

  PhotoWithCreatorRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  );

  PhotoWithCreatorRow filesData(List<PostFileEntry>? filesData);

  PhotoWithCreatorRow hashtags(List<String>? hashtags);

  PhotoWithCreatorRow internalAiDescription(String? internalAiDescription);

  PhotoWithCreatorRow isArchived(bool? isArchived);

  PhotoWithCreatorRow location(String? location);

  PhotoWithCreatorRow postCreatorType(String postCreatorType);

  PhotoWithCreatorRow seoDataWeighted(String? seoDataWeighted);

  PhotoWithCreatorRow taggedCommunityUids(List<String>? taggedCommunityUids);

  PhotoWithCreatorRow taggedUserUids(List<String>? taggedUserUids);

  PhotoWithCreatorRow title(String title);

  PhotoWithCreatorRow totalComments(int? totalComments);

  PhotoWithCreatorRow totalImpressions(int? totalImpressions);

  PhotoWithCreatorRow totalReactions(int? totalReactions);
  ...
  PhotoWithCreatorRow userUid(String userUid);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PhotoWithCreatorRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PhotoWithCreatorRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PhotoWithCreatorRow call({
...
/// Use as `instanceOfPhotoWithCreatorRow.copyWith(...)` or call `instanceOfPhotoWithCreatorRow.copyWith.fieldName(value)` for a single field.
class _$PhotoWithCreatorRowCWProxyImpl implements _$PhotoWithCreatorRowCWProxy {
  const _$PhotoWithCreatorRowCWProxyImpl(this._value);

  final PhotoWithCreatorRow _value;
  ...
  @override
  PhotoWithCreatorRow creator(UsersRow? creator) => call(creator: creator);
  ...
  @override
  PhotoWithCreatorRow location(String? location) => call(location: location);
  ...
  @override
  PhotoWithCreatorRow title(String title) => call(title: title);
  ...
  @override
  PhotoWithCreatorRow userUid(String userUid) => call(userUid: userUid);
...
extension $PhotoWithCreatorRowCopyWith on PhotoWithCreatorRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPhotoWithCreatorRow.copyWith(...)` or `instanceOfPhotoWithCreatorRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PhotoWithCreatorRowCWProxy get copyWith =>
      _$PhotoWithCreatorRowCWProxyImpl(this);
}
...
PhotoWithCreatorRow _$PhotoWithCreatorRowFromJson(
...
Map<String, dynamic> _$PhotoWithCreatorRowToJson(
  PhotoWithCreatorRow instance,
) => <String, dynamic>{
