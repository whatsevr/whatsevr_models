...
part 'wtv_with_creator_row.g.dart';
...
class WtvWithCreatorRow {
  /// Returns a new [WtvWithCreatorRow] instance.
  WtvWithCreatorRow({
  ...
  factory WtvWithCreatorRow.fromJson(Map<String, dynamic> json) =>
      _$WtvWithCreatorRowFromJson(json);

  Map<String, dynamic> toJson() => _$WtvWithCreatorRowToJson(this);
