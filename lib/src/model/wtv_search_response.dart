...
part 'wtv_search_response.g.dart';
...
class WtvSearchResponse {
  /// Returns a new [WtvSearchResponse] instance.
  WtvSearchResponse({
    this.algoliaData,
  ...
  final List<ExternalSearchWtvRow> results;
  ...
  factory WtvSearchResponse.fromJson(Map<String, dynamic> json) =>
      _$WtvSearchResponseFromJson(json);

  Map<String, dynamic> toJson() => _$WtvSearchResponseToJson(this);
