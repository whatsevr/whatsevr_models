...
part of 'related_flick_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$RelatedFlickRowCWProxy {
  RelatedFlickRow addressLatLongWkb(String? addressLatLongWkb);

  RelatedFlickRow author(UsersRow? author);

  RelatedFlickRow communityUid(String? communityUid);

  RelatedFlickRow createdAt(DateTime createdAt);

  RelatedFlickRow creatorLatLongWkb(String? creatorLatLongWkb);

  RelatedFlickRow cumulativeScore(num? cumulativeScore);

  RelatedFlickRow description(String? description);

  RelatedFlickRow externalSearchIndexedAt(DateTime? externalSearchIndexedAt);

  RelatedFlickRow hashtags(List<String>? hashtags);

  RelatedFlickRow internalAiDescription(String? internalAiDescription);

  RelatedFlickRow isArchived(bool? isArchived);

  RelatedFlickRow location(String? location);

  RelatedFlickRow optimizedFiles(Object optimizedFiles);

  RelatedFlickRow postCreatorType(String postCreatorType);

  RelatedFlickRow relatedContentUid(String? relatedContentUid);

  RelatedFlickRow seoDataWeighted(String? seoDataWeighted);

  RelatedFlickRow taggedCommunityUids(List<String>? taggedCommunityUids);

  RelatedFlickRow taggedUserUids(List<String>? taggedUserUids);

  RelatedFlickRow thumbnail(String? thumbnail);

  RelatedFlickRow title(String title);

  RelatedFlickRow totalComments(int? totalComments);

  RelatedFlickRow totalReactions(int? totalReactions);

  RelatedFlickRow totalShares(int? totalShares);
  ...
  RelatedFlickRow user(UsersRow? user);

  RelatedFlickRow userUid(String userUid);

  RelatedFlickRow videoDurationInSec(int? videoDurationInSec);

  RelatedFlickRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `RelatedFlickRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// RelatedFlickRow(...).copyWith(id: 12, name: "My name")
  /// ```
  RelatedFlickRow call({
...
/// Use as `instanceOfRelatedFlickRow.copyWith(...)` or call `instanceOfRelatedFlickRow.copyWith.fieldName(value)` for a single field.
class _$RelatedFlickRowCWProxyImpl implements _$RelatedFlickRowCWProxy {
  const _$RelatedFlickRowCWProxyImpl(this._value);

  final RelatedFlickRow _value;
  ...
  @override
  RelatedFlickRow author(UsersRow? author) => call(author: author);
  ...
  @override
  RelatedFlickRow createdAt(DateTime createdAt) => call(createdAt: createdAt);
  ...
  @override
  RelatedFlickRow hashtags(List<String>? hashtags) => call(hashtags: hashtags);
  ...
  @override
  RelatedFlickRow isArchived(bool? isArchived) => call(isArchived: isArchived);

  @override
  RelatedFlickRow location(String? location) => call(location: location);
  ...
  @override
  RelatedFlickRow thumbnail(String? thumbnail) => call(thumbnail: thumbnail);

  @override
  RelatedFlickRow title(String title) => call(title: title);
  ...
  @override
  RelatedFlickRow user(UsersRow? user) => call(user: user);

  @override
  RelatedFlickRow userUid(String userUid) => call(userUid: userUid);
  ...
  @override
  RelatedFlickRow videoUrl(String videoUrl) => call(videoUrl: videoUrl);
...
extension $RelatedFlickRowCopyWith on RelatedFlickRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfRelatedFlickRow.copyWith(...)` or `instanceOfRelatedFlickRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$RelatedFlickRowCWProxy get copyWith => _$RelatedFlickRowCWProxyImpl(this);
}
...
RelatedFlickRow _$RelatedFlickRowFromJson(
...
Map<String, dynamic> _$RelatedFlickRowToJson(RelatedFlickRow instance) =>
    <String, dynamic>{
