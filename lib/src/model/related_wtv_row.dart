...
class RelatedWtvRow {
  /// Returns a new [RelatedWtvRow] instance.
  RelatedWtvRow({
  ...
  factory RelatedWtvRow.fromJson(Map<String, dynamic> json) =>
      _$RelatedWtvRowFromJson(json);

  Map<String, dynamic> toJson() => _$RelatedWtvRowToJson(this);
