...
class PostsWtvRow {
  /// Returns a new [PostsWtvRow] instance.
  PostsWtvRow({
  ...
  factory PostsWtvRow.fromJson(Map<String, dynamic> json) =>
      _$PostsWtvRowFromJson(json);

  Map<String, dynamic> toJson() => _$PostsWtvRowToJson(this);
