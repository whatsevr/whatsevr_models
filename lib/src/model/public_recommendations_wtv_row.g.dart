...
part of 'public_recommendations_wtv_row.dart';

// **************************************************************************
// CopyWithGenerator
// **************************************************************************

abstract class _$PublicRecommendationsWtvRowCWProxy {
  PublicRecommendationsWtvRow addressLatLongWkb(String? addressLatLongWkb);

  PublicRecommendationsWtvRow communityUid(String? communityUid);

  PublicRecommendationsWtvRow createdAt(DateTime createdAt);

  PublicRecommendationsWtvRow creatorLatLongWkb(String? creatorLatLongWkb);

  PublicRecommendationsWtvRow cumulativeScore(num? cumulativeScore);

  PublicRecommendationsWtvRow description(String? description);

  PublicRecommendationsWtvRow externalSearchIndexedAt(
    DateTime? externalSearchIndexedAt,
  );

  PublicRecommendationsWtvRow hashtags(List<String>? hashtags);

  PublicRecommendationsWtvRow internalAiDescription(
    String? internalAiDescription,
  );

  PublicRecommendationsWtvRow isArchived(bool? isArchived);

  PublicRecommendationsWtvRow location(String? location);

  PublicRecommendationsWtvRow postCreatorType(String postCreatorType);

  PublicRecommendationsWtvRow seoDataWeighted(String? seoDataWeighted);

  PublicRecommendationsWtvRow taggedCommunityUids(
    List<String>? taggedCommunityUids,
  );

  PublicRecommendationsWtvRow taggedUserUids(List<String>? taggedUserUids);

  PublicRecommendationsWtvRow thumbnail(String? thumbnail);

  PublicRecommendationsWtvRow title(String title);

  PublicRecommendationsWtvRow totalComments(int? totalComments);

  PublicRecommendationsWtvRow totalReactions(int? totalReactions);

  PublicRecommendationsWtvRow totalShares(int? totalShares);
  ...
  PublicRecommendationsWtvRow user(UsersRow? user);

  PublicRecommendationsWtvRow userUid(String userUid);

  PublicRecommendationsWtvRow videoDurationInSec(int? videoDurationInSec);

  PublicRecommendationsWtvRow videoUrl(String videoUrl);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `PublicRecommendationsWtvRow(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// PublicRecommendationsWtvRow(...).copyWith(id: 12, name: "My name")
  /// ```
  PublicRecommendationsWtvRow call({
...
/// Use as `instanceOfPublicRecommendationsWtvRow.copyWith(...)` or call `instanceOfPublicRecommendationsWtvRow.copyWith.fieldName(value)` for a single field.
class _$PublicRecommendationsWtvRowCWProxyImpl
    implements _$PublicRecommendationsWtvRowCWProxy {
  const _$PublicRecommendationsWtvRowCWProxyImpl(this._value);

  final PublicRecommendationsWtvRow _value;
  ...
  @override
  PublicRecommendationsWtvRow title(String title) => call(title: title);
  ...
  @override
  PublicRecommendationsWtvRow user(UsersRow? user) => call(user: user);

  @override
  PublicRecommendationsWtvRow userUid(String userUid) => call(userUid: userUid);
  ...
  PublicRecommendationsWtvRow call({
    ...
    return PublicRecommendationsWtvRow(
...
extension $PublicRecommendationsWtvRowCopyWith on PublicRecommendationsWtvRow {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfPublicRecommendationsWtvRow.copyWith(...)` or `instanceOfPublicRecommendationsWtvRow.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$PublicRecommendationsWtvRowCWProxy get copyWith =>
      _$PublicRecommendationsWtvRowCWProxyImpl(this);
}
...
PublicRecommendationsWtvRow _$PublicRecommendationsWtvRowFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'PublicRecommendationsWtvRow',
  json,
  ($checkedConvert) {
    $checkKeys(
      json,
    ...
    final val = PublicRecommendationsWtvRow(
...
Map<String, dynamic> _$PublicRecommendationsWtvRowToJson(
  PublicRecommendationsWtvRow instance,
) => <String, dynamic>{
