...
class PhotoSearchResponse {
  /// Returns a new [PhotoSearchResponse] instance.
  PhotoSearchResponse({
    this.algoliaData,
  ...
  final List<ExternalSearchPhotoRow> results;
  ...
  Map<String, dynamic> toJson() => _$PhotoSearchResponseToJson(this);
