...
part 'private_recommendation_wtv_row.g.dart';
...
class PrivateRecommendationWtvRow {
  /// Returns a new [PrivateRecommendationWtvRow] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is PrivateRecommendationWtvRow &&
  ...
  factory PrivateRecommendationWtvRow.fromJson(Map<String, dynamic> json) =>
      _$PrivateRecommendationWtvRowFromJson(json);

  Map<String, dynamic> toJson() => _$PrivateRecommendationWtvRowToJson(this);
