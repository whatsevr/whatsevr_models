...
part 'collection_items_query.g.dart';
...
class CollectionItemsQuery {
  /// Returns a new [CollectionItemsQuery] instance.
  ...
  factory CollectionItemsQuery.fromJson(Map<String, dynamic> json) =>
      _$CollectionItemsQueryFromJson(json);

  Map<String, dynamic> toJson() => _$CollectionItemsQueryToJson(this);
