...
class CommunityRow {
  /// Returns a new [CommunityRow] instance.
  CommunityRow({
  ...
  factory CommunityRow.fromJson(Map<String, dynamic> json) =>
      _$CommunityRowFromJson(json);

  Map<String, dynamic> toJson() => _$CommunityRowToJson(this);
